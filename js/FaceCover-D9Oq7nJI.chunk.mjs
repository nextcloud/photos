...
import { a2 as commonjsGlobal, I as getDefaultExportFromCjs, d as defineComponent, g as getCurrentUser, L as resultToNode, t as translate, a as translatePlural, _ } from "./vue.runtime.esm-Dri5gLQO.chunk.mjs";
import { al as davClient, at as getPropFind, l as logger, aj as showError } from "./index-BOzawWmL.chunk.mjs";
...
const FaceCoverMixin = defineComponent({
  name: "FaceCoverMixin",
  computed: {
    files() {
...
const FetchFacesMixin = defineComponent({
  ...
  methods: {
    async fetchFaces() {
      ...
      try {
        ...
        const fetchedFace = fetchedRawFaces.map((file) => resultToNode(file, `/recognize/${getCurrentUser()?.uid}/faces/`));
        ...
        logger.error(translate("photos", "Failed to fetch faces list."), { error });
        showError(translate("photos", "Failed to fetch faces list."));
      } finally {
    ...
    async fetchFaceContent(faceName, force) {
      ...
      try {
        ...
        const fetchedFiles = fetchedRawFiles.map((file) => ({
          ...file,
...
const _sfc_main = {
  ...
  computed: {
    ...
    coverUrl() {
      ...
      return _(`/apps/photos/api/v1/preview/${this.cover.fileid}?x=${512}&y=${512}`);
    },
    cover() {
...
var _sfc_render = function render() {
  ...
  } } }, [_c("div", { staticClass: "face-cover__crop-container" }, [_c("img", { ref: "image", staticClass: "face-cover__image", style: _vm.coverDimensions, attrs: { "src": _vm.coverUrl } })]), _c("div", { staticClass: "face-cover__details" }, [!_vm.baseName.match(/^[0-9]+$/) ? _c("div", { staticClass: "face-cover__details__first-line" }, [_c("span", { staticClass: "face-cover__details__name" }, [_vm._v(" " + _vm._s(_vm.baseName) + " ")])]) : _vm._e(), !_vm.small ? _c("div", { staticClass: "face-cover__details__second-line" }, [_vm._v(" " + _vm._s(_vm.n("photos", "%n photos", "%n photos", _vm.face.attributes.nbItems)) + " ")]) : _vm._e()])]);
};
...
__component__.options.__file = "/Users/effem/workbench/git/personel/photos/src/components/Faces/FaceCover.vue";
const FaceCover = __component__.exports;
export {
  FetchFacesMixin as F,
  FaceCoverMixin as a,
  FaceCover as b
};
//# sourceMappingURL=FaceCover-D9Oq7nJI.chunk.mjs.map

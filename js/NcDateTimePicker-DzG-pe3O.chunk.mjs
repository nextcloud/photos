...
TZNAME:SST\r
DTSTART:19700101T000000\r
END:STANDARD`]}},Y0={version:Xe,aliases:tr,zones:er};class rr{_aliases=new Map;_timezones=new Map;_pendingAliases=[];getTimezoneForId(t){let r=0;for(;r++<20;){if(this._timezones.has(t))return this._timezones.get(t);if(this._aliases.has(t))t=this._aliases.get(t);else return null}return console.error("TimezoneManager.getTimezoneForIdRec() exceeds recursion limits"),null}hasTimezoneForId(t){return this._timezones.has(t)||this._aliases.has(t)}isAlias(t){return!this._timezones.has(t)&&this._aliases.has(t)}listAllTimezones(t=!1){const r=Array.from(this._timezones.keys());return t?r.concat(Array.from(this._aliases.keys())):r}registerTimezone(t){this._timezones.set(t.timezoneId,t),Z.TimezoneService.register(t.toICALTimezone(),t.timezoneId),this._pendingAliases=this._pendingAliases.filter(([r,T])=>T!==t.timezoneId?!0:(Z.TimezoneService.register(t.toICALTimezone(),r),!1))}registerDefaultTimezones(){console.debug(`@nextcloud/calendar-js app is using version ${Y0.version} of the timezone database`);for(const t in Y0.zones){const r=["BEGIN:VTIMEZONE","TZID:"+t,...Y0.zones[t].ics,"END:VTIMEZONE"].join(`\r
`);this.registerTimezoneFromICS(t,r)}for(const t in Y0.aliases)this.registerAlias(t,Y0.aliases[t].aliasTo)}registerTimezoneFromICS(t,r){const T=new r0(t,r);this.registerTimezone(T)}registerAlias(t,r){this._aliases.set(t,r);const T=this.getTimezoneForId(r);if(!T){this._pendingAliases.push([t,r]);return}Z.TimezoneService.register(T.toICALTimezone(),t)}unregisterTimezones(t){this._timezones.delete(t),Z.TimezoneService.remove(t)}unregisterAlias(t){this._aliases.delete(t),this._pendingAliases=this._pendingAliases.filter(([r])=>r!==t),Z.TimezoneService.remove(t)}clearAllTimezones(){this._aliases=new Map,this._pendingAliases=[],this._timezones=new Map,Z.TimezoneService.reset(),F0.registerTimezone(r0.utc),F0.registerTimezone(r0.floating),F0.registerAlias("GMT",r0.utc.timezoneId),F0.registerAlias("Z",r0.utc.timezoneId)}}const F0=new rr;F0.clearAllTimezones();function Tr(){return F0}Rt(Se);function ir(e=[],t=[]){const r={},T=[];for(const i of e){const a=i.split("/");let[n,s]=[a.shift(),a.join("/")];s||(s=n,n=k("Global")),r[n]=r[n]||{continent:n,regions:[]},r[n].regions.push({label:ee(s),cities:[],timezoneId:i})}for(const i of t){const{continent:a,label:n,timezoneId:s}=i;r[a]=r[a]||{continent:a,regions:[]},r[a].regions.push({label:n,cities:[],timezoneId:s})}for(const i in r)Object.prototype.hasOwnProperty.call(r,i)&&(r[i].regions.sort((a,n)=>a.label<n.label?-1:1),T.push(r[i]));return T.sort((i,a)=>i.continent<a.continent?-1:1),T}function ee(e){return e.split("_").join(" ").replace("St ","St. ").split("/").join(" - ")}const Ut=Tr();let vt=!1;function ar(){return vt||(Ut.registerDefaultTimezones(),vt=!0),Ut}Rt(ce);const nr={name:"NcTimezonePicker",components:{NcSelect:de},model:{prop:"modelValue",event:"update:modelValue"},props:{additionalTimezones:{type:Array,default:()=>[]},value:{type:String,default:void 0},modelValue:{type:String,default:"floating"},uid:{type:[String,Number],default:()=>`tz-${$t(5)}`}},emits:["input","update:modelValue","update:model-value"],setup(){return{model:Kt("value","input")}},computed:{placeholder(){return k("Type to search time zone")},selectedTimezone(){for(const e of this.additionalTimezones)if(e.timezoneId===this.model)return e;return{label:ee(this.model),timezoneId:this.model}},options(){const e=ar(),t=ir(e.listAllTimezones(),this.additionalTimezones);let r=[];return Object.values(t).forEach(T=>{r=r.concat(T.regions)}),r}},methods:{t:k,change(e){e&&(this.model=e.timezoneId)},isSelectable(e){return!e.timezoneId.startsWith("tz-group__")},filterBy(e,t,r){const T=r.trim().split(" ");return e.timezoneId.startsWith("tz-group__")?e.regions.some(i=>this.matchTimezoneId(i.timezoneId,T)):this.matchTimezoneId(e.timezoneId,T)},matchTimezoneId(e,t){return t.every(r=>e.toLowerCase().includes(r.toLowerCase()))}}};var sr=function(){var e=this,t=e._self._c;return t("NcSelect",{attrs:{"aria-label-combobox":e.t("Search for time zone"),clearable:!1,"filter-by":e.filterBy,multiple:!1,options:e.options,placeholder:e.placeholder,selectable:e.isSelectable,uid:e.uid,value:e.selectedTimezone,label:"label"},on:{"option:selected":e.change}})},Ar=[],or=$0(nr,sr,Ar,!1,null,null);const lr=or.exports;function re(e){return e instanceof Date||Object.prototype.toString.call(e)==="[object Date]"}function J0(e){return re(e)?new Date(e.getTime()):e==null?new Date(NaN):new Date(e)}function Er(e){return re(e)&&!isNaN(e.getTime())}function Te(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0;if(!(t>=0&&t<=6))throw new RangeError("weekStartsOn must be between 0 and 6");var r=J0(e),T=r.getDay(),i=(T+7-t)%7;return r.setDate(r.getDate()-i),r.setHours(0,0,0,0),r}function ie(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},r=t.firstDayOfWeek,T=r===void 0?0:r,i=t.firstWeekContainsDate,a=i===void 0?1:i;if(!(a>=1&&a<=7))throw new RangeError("firstWeekContainsDate must be between 1 and 7");for(var n=J0(e),s=n.getFullYear(),A=new Date(0),o=s+1;o>=s-1&&(A.setFullYear(o,0,a),A.setHours(0,0,0,0),A=Te(A,T),!(n.getTime()>=A.getTime()));o--);return A}function dt(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},r=t.firstDayOfWeek,T=r===void 0?0:r,i=t.firstWeekContainsDate,a=i===void 0?1:i,n=J0(e),s=Te(n,T),A=ie(n,{firstDayOfWeek:T,firstWeekContainsDate:a}),o=s.getTime()-A.getTime();return Math.round(o/(7*24*3600*1e3))+1}var ae={months:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],weekdays:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],weekdaysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],weekdaysMin:["Su","Mo","Tu","We","Th","Fr","Sa"],firstDayOfWeek:0,firstWeekContainsDate:1},Dr=/\[([^\]]+)]|YYYY|YY?|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|m{1,2}|s{1,2}|Z{1,2}|S{1,3}|w{1,2}|x|X|a|A/g;function v(e){for(var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:2,r="".concat(Math.abs(e)),T=e<0?"-":"";r.length<t;)r="0".concat(r);return T+r}function Ct(e){return Math.round(e.getTimezoneOffset()/15)*15}function bt(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"",r=e>0?"-":"+",T=Math.abs(e),i=Math.floor(T/60),a=T%60;return r+v(i,2)+t+v(a,2)}var _t=function(e,t,r){var T=e<12?"AM":"PM";return r?T.toLocaleLowerCase():T},f0={Y:function(e){var t=e.getFullYear();return t<=9999?"".concat(t):"+".concat(t)},YY:function(e){return v(e.getFullYear(),4).substr(2)},YYYY:function(e){return v(e.getFullYear(),4)},M:function(e){return e.getMonth()+1},MM:function(e){return v(e.getMonth()+1,2)},MMM:function(e,t){return t.monthsShort[e.getMonth()]},MMMM:function(e,t){return t.months[e.getMonth()]},D:function(e){return e.getDate()},DD:function(e){return v(e.getDate(),2)},H:function(e){return e.getHours()},HH:function(e){return v(e.getHours(),2)},h:function(e){var t=e.getHours();return t===0?12:t>12?t%12:t},hh:function(){var e=f0.h.apply(f0,arguments);return v(e,2)},m:function(e){return e.getMinutes()},mm:function(e){return v(e.getMinutes(),2)},s:function(e){return e.getSeconds()},ss:function(e){return v(e.getSeconds(),2)},S:function(e){return Math.floor(e.getMilliseconds()/100)},SS:function(e){return v(Math.floor(e.getMilliseconds()/10),2)},SSS:function(e){return v(e.getMilliseconds(),3)},d:function(e){return e.getDay()},dd:function(e,t){return t.weekdaysMin[e.getDay()]},ddd:function(e,t){return t.weekdaysShort[e.getDay()]},dddd:function(e,t){return t.weekdays[e.getDay()]},A:function(e,t){var r=t.meridiem||_t;return r(e.getHours(),e.getMinutes(),!1)},a:function(e,t){var r=t.meridiem||_t;return r(e.getHours(),e.getMinutes(),!0)},Z:function(e){return bt(Ct(e),":")},ZZ:function(e){return bt(Ct(e))},X:function(e){return Math.floor(e.getTime()/1e3)},x:function(e){return e.getTime()},w:function(e,t){return dt(e,{firstDayOfWeek:t.firstDayOfWeek,firstWeekContainsDate:t.firstWeekContainsDate})},ww:function(e,t){return v(f0.w(e,t),2)}};function q0(e,t){var r=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},T=t?String(t):"YYYY-MM-DDTHH:mm:ss.SSSZ",i=J0(e);if(!Er(i))return"Invalid Date";var a=r.locale||ae;return T.replace(Dr,function(n,s){return s||(typeof f0[n]=="function"?"".concat(f0[n](i,a)):n)})}function wt(e){return cr(e)||Sr(e)||ur()}function ur(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function Sr(e){if(Symbol.iterator in Object(e)||Object.prototype.toString.call(e)==="[object Arguments]")return Array.from(e)}function cr(e){if(Array.isArray(e)){for(var t=0,r=new Array(e.length);t<e.length;t++)r[t]=e[t];return r}}function kt(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var T=Object.getOwnPropertySymbols(e);t&&(T=T.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),r.push.apply(r,T)}return r}function Rr(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]!=null?arguments[t]:{};t%2?kt(r,!0).forEach(function(T){T0(e,T,r[T])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):kt(r).forEach(function(T){Object.defineProperty(e,T,Object.getOwnPropertyDescriptor(r,T))})}return e}function Fr(e,t){return Or(e)||dr(e,t)||Nr()}function Nr(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function dr(e,t){if(Symbol.iterator in Object(e)||Object.prototype.toString.call(e)==="[object Arguments]"){var r=[],T=!0,i=!1,a=void 0;try{for(var n=e[Symbol.iterator](),s;!(T=(s=n.next()).done)&&(r.push(s.value),!(t&&r.length===t));T=!0);}catch(A){i=!0,a=A}finally{try{!T&&n.return!=null&&n.return()}finally{if(i)throw a}}return r}}function Or(e){if(Array.isArray(e))return e}function T0(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}var hr=/(\[[^\[]*\])|(MM?M?M?|Do|DD?|ddd?d?|w[o|w]?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|S{1,3}|x|X|ZZ?|.)/g,ne=/\d/,t0=/\d\d/,Yr=/\d{3}/,mr=/\d{4}/,c0=/\d\d?/,fr=/[+-]\d\d:?\d\d/,se=/[+-]?\d+/,Mr=/[+-]?\d+(\.\d{1,3})?/,nt="year",k0="month",xt="day",Pt="hour",Qt="minute",zt="second",st="millisecond",Ae={},h=function(e,t,r){var T=Array.isArray(e)?e:[e],i;typeof r=="string"?i=function(a){var n=parseInt(a,10);return T0({},r,n)}:i=r,T.forEach(function(a){Ae[a]=[t,i]})},Zr=function(e){return e.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&")},M0=function(e){return function(t){var r=t[e];if(!Array.isArray(r))throw new Error("Locale[".concat(e,"] need an array"));return new RegExp(r.map(Zr).join("|"))}},Z0=function(e,t){return function(r,T){var i=T[e];if(!Array.isArray(i))throw new Error("Locale[".concat(e,"] need an array"));var a=i.indexOf(r);if(a<0)throw new Error("Invalid Word");return T0({},t,a)}};h("Y",se,nt),h("YY",t0,function(e){var t=new Date().getFullYear(),r=Math.floor(t/100),T=parseInt(e,10);return T=(T>68?r-1:r)*100+T,T0({},nt,T)}),h("YYYY",mr,nt),h("M",c0,function(e){return T0({},k0,parseInt(e,10)-1)}),h("MM",t0,function(e){return T0({},k0,parseInt(e,10)-1)}),h("MMM",M0("monthsShort"),Z0("monthsShort",k0)),h("MMMM",M0("months"),Z0("months",k0)),h("D",c0,xt),h("DD",t0,xt),h(["H","h"],c0,Pt),h(["HH","hh"],t0,Pt),h("m",c0,Qt),h("mm",t0,Qt),h("s",c0,zt),h("ss",t0,zt),h("S",ne,function(e){return T0({},st,parseInt(e,10)*100)}),h("SS",t0,function(e){return T0({},st,parseInt(e,10)*10)}),h("SSS",Yr,st);function pr(e){return e.meridiemParse||/[ap]\.?m?\.?/i}function Br(e){return"".concat(e).toLowerCase().charAt(0)==="p"}h(["A","a"],pr,function(e,t){var r=typeof t.isPM=="function"?t.isPM(e):Br(e);return{isPM:r}});function gr(e){var t=e.match(/([+-]|\d\d)/g)||["-","0","0"],r=Fr(t,3),T=r[0],i=r[1],a=r[2],n=parseInt(i,10)*60+parseInt(a,10);return n===0?0:T==="+"?-n:+n}h(["Z","ZZ"],fr,function(e){return{offset:gr(e)}}),h("x",se,function(e){return{date:new Date(parseInt(e,10))}}),h("X",Mr,function(e){return{date:new Date(parseFloat(e)*1e3)}}),h("d",ne,"weekday"),h("dd",M0("weekdaysMin"),Z0("weekdaysMin","weekday")),h("ddd",M0("weekdaysShort"),Z0("weekdaysShort","weekday")),h("dddd",M0("weekdays"),Z0("weekdays","weekday")),h("w",c0,"week"),h("ww",t0,"week");function yr(e,t){if(e!==void 0&&t!==void 0){if(t){if(e<12)return e+12}else if(e===12)return 0}return e}function Ir(e){for(var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:new Date,r=[0,0,1,0,0,0,0],T=[t.getFullYear(),t.getMonth(),t.getDate(),t.getHours(),t.getMinutes(),t.getSeconds(),t.getMilliseconds()],i=!0,a=0;a<7;a++)e[a]===void 0?r[a]=i?T[a]:r[a]:(r[a]=e[a],i=!1);return r}function Lr(e,t,r,T,i,a,n){var s;return e<100&&e>=0?(s=new Date(e+400,t,r,T,i,a,n),isFinite(s.getFullYear())&&s.setFullYear(e)):s=new Date(e,t,r,T,i,a,n),s}function Gr(){for(var e,t=arguments.length,r=new Array(t),T=0;T<t;T++)r[T]=arguments[T];var i=r[0];return i<100&&i>=0?(r[0]+=400,e=new Date(Date.UTC.apply(Date,r)),isFinite(e.getUTCFullYear())&&e.setUTCFullYear(i)):e=new Date(Date.UTC.apply(Date,r)),e}function Hr(e,t,r){var T=t.match(hr);if(!T)throw new Error;for(var i=T.length,a={},n=0;n<i;n+=1){var s=T[n],A=Ae[s];if(A){var o=typeof A[0]=="function"?A[0](r):A[0],l=A[1],D=(o.exec(e)||[])[0],S=l(D,r);a=Rr({},a,{},S),e=e.replace(D,"")}else{var c=s.replace(/^\[|\]$/g,"");if(e.indexOf(c)===0)e=e.substr(c.length);else throw new Error("not match")}}return a}function Ur(e,t){var r=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};try{var T=r.locale,i=T===void 0?ae:T,a=r.backupDate,n=a===void 0?new Date:a,s=Hr(e,t,i),A=s.year,o=s.month,l=s.day,D=s.hour,S=s.minute,c=s.second,R=s.millisecond,u=s.isPM,F=s.date,M=s.offset,S0=s.weekday,$=s.week;if(F)return F;var et=[A,o,l,D,S,c,R];if(et[3]=yr(et[3],u),$!==void 0&&o===void 0&&l===void 0){var ue=ie(A===void 0?n:new Date(A,3),{firstDayOfWeek:i.firstDayOfWeek,firstWeekContainsDate:i.firstWeekContainsDate});return new Date(ue.getTime()+($-1)*7*24*3600*1e3)}var H0,rt=Ir(et,n);return M!==void 0?(rt[6]+=M*60*1e3,H0=Gr.apply(void 0,wt(rt))):H0=Lr.apply(void 0,wt(rt)),S0!==void 0&&H0.getDay()!==S0?new Date(NaN):H0}catch{return new Date(NaN)}}function z0(e){"@babel/helpers - typeof";return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?z0=function(t){return typeof t}:z0=function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},z0(e)}function A0(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function Dt(){return Dt=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var T in r)Object.prototype.hasOwnProperty.call(r,T)&&(e[T]=r[T])}return e},Dt.apply(this,arguments)}function Vt(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var T=Object.getOwnPropertySymbols(e);t&&(T=T.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),r.push.apply(r,T)}return r}function m(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]!=null?arguments[t]:{};t%2?Vt(Object(r),!0).forEach(function(T){A0(e,T,r[T])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):Vt(Object(r)).forEach(function(T){Object.defineProperty(e,T,Object.getOwnPropertyDescriptor(r,T))})}return e}function vr(e,t){if(e==null)return{};var r={},T=Object.keys(e),i,a;for(a=0;a<T.length;a++)i=T[a],!(t.indexOf(i)>=0)&&(r[i]=e[i]);return r}function Cr(e,t){if(e==null)return{};var r=vr(e,t),T,i;if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);for(i=0;i<a.length;i++)T=a[i],!(t.indexOf(T)>=0)&&Object.prototype.propertyIsEnumerable.call(e,T)&&(r[T]=e[T])}return r}function p0(e,t){return br(e)||_r(e,t)||wr(e,t)||kr()}function br(e){if(Array.isArray(e))return e}function _r(e,t){if(!(typeof Symbol>"u"||!(Symbol.iterator in Object(e)))){var r=[],T=!0,i=!1,a=void 0;try{for(var n=e[Symbol.iterator](),s;!(T=(s=n.next()).done)&&(r.push(s.value),!(t&&r.length===t));T=!0);}catch(A){i=!0,a=A}finally{try{!T&&n.return!=null&&n.return()}finally{if(i)throw a}}return r}}function wr(e,t){if(e){if(typeof e=="string")return jt(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);if(r==="Object"&&e.constructor&&(r=e.constructor.name),r==="Map"||r==="Set")return Array.from(r);if(r==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r))return jt(e,t)}}function jt(e,t){(t==null||t>e.length)&&(t=e.length);for(var r=0,T=new Array(t);r<t;r++)T[r]=e[r];return T}function kr(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function ut(){return ut=Object.assign||function(e){for(var t,r=1;r<arguments.length;r++)for(var T in t=arguments[r],t)Object.prototype.hasOwnProperty.call(t,T)&&(e[T]=t[T]);return e},ut.apply(this,arguments)}var xr=["attrs","props","domProps"],Pr=["class","style","directives"],Qr=["on","nativeOn"],zr=function(e){return e.reduce(function(t,r){for(var T in r)if(!t[T])t[T]=r[T];else if(xr.indexOf(T)!==-1)t[T]=ut({},t[T],r[T]);else if(Pr.indexOf(T)!==-1){var i=t[T]instanceof Array?t[T]:[t[T]],a=r[T]instanceof Array?r[T]:[r[T]];t[T]=i.concat(a)}else if(Qr.indexOf(T)!==-1)for(var n in r[T])if(t[T][n]){var s=t[T][n]instanceof Array?t[T][n]:[t[T][n]],A=r[T][n]instanceof Array?r[T][n]:[r[T][n]];t[T][n]=s.concat(A)}else t[T][n]=r[T][n];else if(T=="hook")for(var o in r[T])t[T][o]=t[T][o]?Vr(t[T][o],r[T][o]):r[T][o];else t[T]=r[T];return t},{})},Vr=function(e,t){return function(){e&&e.apply(this,arguments),t&&t.apply(this,arguments)}},G0=zr;function j(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,r=arguments.length>2&&arguments[2]!==void 0?arguments[2]:1,T=arguments.length>3&&arguments[3]!==void 0?arguments[3]:0,i=arguments.length>4&&arguments[4]!==void 0?arguments[4]:0,a=arguments.length>5&&arguments[5]!==void 0?arguments[5]:0,n=arguments.length>6&&arguments[6]!==void 0?arguments[6]:0,s=new Date(e,t,r,T,i,a,n);return e<100&&e>=0&&s.setFullYear(e),s}function W(e){return e instanceof Date&&!isNaN(e)}function X0(e){return Array.isArray(e)&&e.length===2&&e.every(W)&&e[0]<=e[1]}function jr(e){return Array.isArray(e)&&e.every(W)}function N0(e){var t=new Date(e);if(W(t))return t;for(var r=arguments.length,T=new Array(r>1?r-1:0),i=1;i<r;i++)T[i-1]=arguments[i];return T.length?N0.apply(void 0,T):new Date}function Wr(e){var t=new Date(e);return t.setMonth(0,1),t.setHours(0,0,0,0),t}function St(e){var t=new Date(e);return t.setDate(1),t.setHours(0,0,0,0),t}function $r(e){var t=new Date(e);return t.setHours(0,0,0,0),t}function Kr(e){for(var t=e.firstDayOfWeek,r=e.year,T=e.month,i=[],a=j(r,T,0),n=a.getDate(),s=n-(a.getDay()+7-t)%7,A=s;A<=n;A++)i.push(j(r,T,A-n));a.setMonth(T+1,0);for(var o=a.getDate(),l=1;l<=o;l++)i.push(j(r,T,l));for(var D=n-s+1,S=6*7-D-o,c=1;c<=S;c++)i.push(j(r,T,o+c));return i}function ct(e,t){var r=new Date(e),T=typeof t=="function"?t(r.getMonth()):Number(t),i=r.getFullYear(),a=j(i,T+1,0).getDate(),n=r.getDate();return r.setMonth(T,Math.min(n,a)),r}function d0(e,t){var r=new Date(e),T=typeof t=="function"?t(r.getFullYear()):t;return r.setFullYear(T),r}function W0(e,t){var r=new Date(e),T=new Date(t);return r.setHours(T.getHours(),T.getMinutes(),T.getSeconds()),r}function Ot(e,t){if(!Array.isArray(e))return[];var r=[],T=e.length,i=0;for(t=t||T;i<T;)r.push(e.slice(i,i+=t));return r}function P(e){return Object.prototype.toString.call(e)==="[object Object]"}function O0(e,t){if(!P(e))return{};Array.isArray(t)||(t=[t]);var r={};return t.forEach(function(T){T in e&&(r[T]=e[T])}),r}function oe(e,t){if(!P(e))return{};var r=e;return P(t)&&Object.keys(t).forEach(function(T){var i=t[T];P(i)&&P(e[T])&&(i=oe(e[T],i)),r=m({},r,A0({},T,i))}),r}function Jr(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}function qr(e,t){return t={exports:{}},e(t,t.exports),t.exports}var Xr=qr(function(e,t){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r={months:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],weekdays:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],weekdaysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],weekdaysMin:["Su","Mo","Tu","We","Th","Fr","Sa"],firstDayOfWeek:0,firstWeekContainsDate:1},T=r;t.default=T,e.exports=t.default}),tT=Jr(Xr),eT={formatLocale:tT,yearFormat:"YYYY",monthFormat:"MMM",monthBeforeYear:!0},m0="en",R0={};R0[m0]=eT;function le(e,t,r){if(typeof e!="string")return R0[m0];var T=m0;return R0[e]&&(T=e),t&&(R0[e]=t,T=e),r||(m0=T),R0[e]||R0[m0]}function h0(e){return le(e,null,!0)}function rT(e){var t=!1;return function(){for(var r=this,T=arguments.length,i=new Array(T),a=0;a<T;a++)i[a]=arguments[a];t||(t=!0,requestAnimationFrame(function(){t=!1,e.apply(r,i)}))}}function TT(e){var t=e.style.display,r=e.style.visibility;e.style.display="block",e.style.visibility="hidden";var T=window.getComputedStyle(e),i=e.offsetWidth+parseInt(T.marginLeft,10)+parseInt(T.marginRight,10),a=e.offsetHeight+parseInt(T.marginTop,10)+parseInt(T.marginBottom,10);return e.style.display=t,e.style.visibility=r,{width:i,height:a}}function iT(e,t,r,T){var i=0,a=0,n=0,s=0,A=e.getBoundingClientRect(),o=document.documentElement.clientWidth,l=document.documentElement.clientHeight;return T&&(n=window.pageXOffset+A.left,s=window.pageYOffset+A.top),o-A.left<t&&A.right<t?i=n-A.left+1:A.left+A.width/2<=o/2?i=n:i=n+A.width-t,A.top<=r&&l-A.bottom<=r?a=s+l-A.top-r:A.top+A.height/2<=l/2?a=s+A.height:a=s-r,{left:"".concat(i,"px"),top:"".concat(a,"px")}}function tt(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:document.body;if(!e||e===t)return null;var r=function(a,n){return getComputedStyle(a,null).getPropertyValue(n)},T=/(auto|scroll)/,i=T.test(r(e,"overflow")+r(e,"overflow-y")+r(e,"overflow-x"));return i?e:tt(e.parentNode,t)}var aT={name:"Popup",inject:{prefixClass:{default:"mx"}},props:{visible:{type:Boolean,default:!1},appendToBody:{type:Boolean,default:!0}},data:function(){return{top:"",left:""}},watch:{visible:{immediate:!0,handler:function(e){var t=this;this.$nextTick(function(){e&&t.displayPopup()})}}},mounted:function(){var e=this;this.appendToBody&&document.body.appendChild(this.$el),this._clickoutEvent="ontouchend"in document?"touchstart":"mousedown",document.addEventListener(this._clickoutEvent,this.handleClickOutside);var t=this.$parent.$el;this._displayPopup=rT(function(){return e.displayPopup()}),this._scrollParent=tt(t)||window,this._scrollParent.addEventListener("scroll",this._displayPopup),window.addEventListener("resize",this._displayPopup)},beforeDestroy:function(){this.appendToBody&&this.$el.parentNode&&this.$el.parentNode.removeChild(this.$el),document.removeEventListener(this._clickoutEvent,this.handleClickOutside),this._scrollParent.removeEventListener("scroll",this._displayPopup),window.removeEventListener("resize",this._displayPopup)},methods:{handleClickOutside:function(e){if(this.visible){var t=e.target,r=this.$el;r&&!r.contains(t)&&this.$emit("clickoutside",e)}},displayPopup:function(){if(this.visible){var e=this.$el,t=this.$parent.$el,r=this.appendToBody;this._popupRect||(this._popupRect=TT(e));var T=this._popupRect,i=T.width,a=T.height,n=iT(t,i,a,r),s=n.left,A=n.top;this.left=s,this.top=A}}}};function _(e,t,r,T,i,a,n,s,A,o){var l=typeof r=="function"?r.options:r;return e&&e.render&&(l.render=e.render,l.staticRenderFns=e.staticRenderFns,l._compiled=!0),r}var nT=aT,sT=function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("transition",{attrs:{name:e.prefixClass+"-zoom-in-down"}},[e.visible?r("div",{class:e.prefixClass+"-datepicker-main "+e.prefixClass+"-datepicker-popup",style:{top:e.top,left:e.left,position:"absolute"}},[e._t("default")],2):e._e()])},AT=[],oT=void 0,lT=_({render:sT,staticRenderFns:AT},oT,nT),ET=function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("svg",{attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 1024 1024",width:"1em",height:"1em"}},[r("path",{attrs:{d:"M940.218182 107.054545h-209.454546V46.545455h-65.163636v60.50909H363.054545V46.545455H297.890909v60.50909H83.781818c-18.618182 0-32.581818 13.963636-32.581818 32.581819v805.236363c0 18.618182 13.963636 32.581818 32.581818 32.581818h861.090909c18.618182 0 32.581818-13.963636 32.581818-32.581818V139.636364c-4.654545-18.618182-18.618182-32.581818-37.236363-32.581819zM297.890909 172.218182V232.727273h65.163636V172.218182h307.2V232.727273h65.163637V172.218182h176.872727v204.8H116.363636V172.218182h181.527273zM116.363636 912.290909V442.181818h795.927273v470.109091H116.363636z"}})])},DT=[],uT=void 0,ST=_({render:ET,staticRenderFns:DT},uT,{}),cT=function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("svg",{attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"1em",height:"1em"}},[r("path",{attrs:{d:"M0 0h24v24H0z",fill:"none"}}),e._v(" "),r("path",{attrs:{d:"M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"}}),e._v(" "),r("path",{attrs:{d:"M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"}})])},RT=[],FT=void 0,NT=_({render:cT,staticRenderFns:RT},FT,{}),dT=function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("svg",{attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 1024 1024",width:"1em",height:"1em"}},[r("path",{attrs:{d:"M810.005333 274.005333l-237.994667 237.994667 237.994667 237.994667-60.010667 60.010667-237.994667-237.994667-237.994667 237.994667-60.010667-60.010667 237.994667-237.994667-237.994667-237.994667 60.010667-60.010667 237.994667 237.994667 237.994667-237.994667z"}})])},OT=[],hT=void 0,YT=_({render:dT,staticRenderFns:OT},hT,{}),mT={props:{type:String,disabled:Boolean},inject:{prefixClass:{default:"mx"}}},fT=mT,MT=function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("button",e._g({class:[e.prefixClass+"-btn "+e.prefixClass+"-btn-text "+e.prefixClass+"-btn-icon-"+e.type,{disabled:e.disabled}],attrs:{type:"button",disabled:e.disabled}},e.$listeners),[r("i",{class:e.prefixClass+"-icon-"+e.type})])},ZT=[],pT=void 0,ht=_({render:MT,staticRenderFns:ZT},pT,fT),BT={name:"TableDate",components:{IconButton:ht},inject:{getLocale:{default:function(){return h0}},getWeek:{default:function(){return dt}},prefixClass:{default:"mx"},onDateMouseEnter:{default:void 0},onDateMouseLeave:{default:void 0}},props:{disabledCalendarChanger:{type:Function,default:function(){return!1}},calendar:{type:Date,default:function(){return new Date}},showWeekNumber:{type:Boolean,default:!1},titleFormat:{type:String,default:"YYYY-MM-DD"},getRowClasses:{type:Function,default:function(){return[]}},getCellClasses:{type:Function,default:function(){return[]}}},computed:{firstDayOfWeek:function(){return this.getLocale().formatLocale.firstDayOfWeek||0},yearMonth:function(){var e=this.getLocale(),t=e.yearFormat,r=e.monthBeforeYear,T=e.monthFormat,i=T===void 0?"MMM":T,a={panel:"year",label:this.formatDate(this.calendar,t)},n={panel:"month",label:this.formatDate(this.calendar,i)};return r?[n,a]:[a,n]},days:function(){var e=this.getLocale(),t=e.days||e.formatLocale.weekdaysMin;return t.concat(t).slice(this.firstDayOfWeek,this.firstDayOfWeek+7)},dates:function(){var e=this.calendar.getFullYear(),t=this.calendar.getMonth(),r=Kr({firstDayOfWeek:this.firstDayOfWeek,year:e,month:t});return Ot(r,7)}},methods:{isDisabledArrows:function(e){var t=new Date(this.calendar);switch(e){case"last-year":t.setFullYear(t.getFullYear()-1,t.getMonth()+1,0),t.setHours(23,59,59,999);break;case"next-year":t.setFullYear(t.getFullYear()+1);break;case"last-month":t.setMonth(t.getMonth(),0),t.setHours(23,59,59,999);break;case"next-month":t.setMonth(t.getMonth()+1);break}return this.disabledCalendarChanger(t,e)},handleIconLeftClick:function(){this.$emit("changecalendar",ct(this.calendar,function(e){return e-1}),"last-month")},handleIconRightClick:function(){this.$emit("changecalendar",ct(this.calendar,function(e){return e+1}),"next-month")},handleIconDoubleLeftClick:function(){this.$emit("changecalendar",d0(this.calendar,function(e){return e-1}),"last-year")},handleIconDoubleRightClick:function(){this.$emit("changecalendar",d0(this.calendar,function(e){return e+1}),"next-year")},handlePanelChange:function(e){this.$emit("changepanel",e)},handleMouseEnter:function(e){typeof this.onDateMouseEnter=="function"&&this.onDateMouseEnter(e)},handleMouseLeave:function(e){typeof this.onDateMouseLeave=="function"&&this.onDateMouseLeave(e)},handleCellClick:function(e){var t=e.target;t.tagName.toUpperCase()==="DIV"&&(t=t.parentNode);var r=t.getAttribute("data-row-col");if(r){var T=r.split(",").map(function(A){return parseInt(A,10)}),i=p0(T,2),a=i[0],n=i[1],s=this.dates[a][n];this.$emit("select",new Date(s))}},formatDate:function(e,t){return q0(e,t,{locale:this.getLocale().formatLocale})},getCellTitle:function(e){var t=this.titleFormat;return this.formatDate(e,t)},getWeekNumber:function(e){return this.getWeek(e,this.getLocale().formatLocale)}}},gT=BT,yT=function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("div",{class:e.prefixClass+"-calendar "+e.prefixClass+"-calendar-panel-date"},[r("div",{class:e.prefixClass+"-calendar-header"},[r("icon-button",{attrs:{type:"double-left",disabled:e.isDisabledArrows("last-year")},on:{click:e.handleIconDoubleLeftClick}}),e._v(" "),r("icon-button",{attrs:{type:"left",disabled:e.isDisabledArrows("last-month")},on:{click:e.handleIconLeftClick}}),e._v(" "),r("icon-button",{attrs:{type:"double-right",disabled:e.isDisabledArrows("next-year")},on:{click:e.handleIconDoubleRightClick}}),e._v(" "),r("icon-button",{attrs:{type:"right",disabled:e.isDisabledArrows("next-month")},on:{click:e.handleIconRightClick}}),e._v(" "),r("span",{class:e.prefixClass+"-calendar-header-label"},e._l(e.yearMonth,function(T){return r("button",{key:T.panel,class:e.prefixClass+"-btn "+e.prefixClass+"-btn-text "+e.prefixClass+"-btn-current-"+T.panel,attrs:{type:"button"},on:{click:function(i){return e.handlePanelChange(T.panel)}}},[e._v(`
        `+e._s(T.label)+`

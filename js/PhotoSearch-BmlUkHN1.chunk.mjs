import{j as c,b as m,r as u}from"./vue.runtime.esm-wF2fFWue.chunk.mjs";import{m as r}from"./index-BbxzoNy3.chunk.mjs";import{b as h,p as f,g,d as y}from"./index-CTNdzbN6.chunk.mjs";async function v(o={}){const d={firstResult:0,nbResults:200,mimesType:h,onThisDay:!1,onlyFavorites:!1,full:!1,extraFilters:"",...o},s=d.mimesType.reduce((e,t)=>`${e}
		<d:eq>
			<d:prop>
				<d:getcontenttype/>
			</d:prop>
...
`);return d.data=`<?xml version="1.0" encoding="UTF-8"?>
		...
		</d:searchrequest>`,d.details=!0,(await y.search("/",d)).data.results.map(e=>u(e))}export{v as g};
//# sourceMappingURL=PhotoSearch-BmlUkHN1.chunk.mjs.map

import{N as c,I as m,G as u}from"./vue.runtime.esm-DE8Vf-Sj.chunk.mjs";import{m as r}from"./index-CKppNoVt.chunk.mjs";import{h as f,p as h,ap as g,am as y}from"./index-DiDFXBG0.chunk.mjs";async function F(o={}){const d={firstResult:0,nbResults:200,mimesType:f,onThisDay:!1,onlyFavorites:!1,full:!1,extraFilters:"",...o},s=d.mimesType.reduce((t,e)=>`${t}
		<d:eq>
			<d:prop>
				<d:getcontenttype/>
			</d:prop>
...
`);return d.data=`<?xml version="1.0" encoding="UTF-8"?>
		...
		</d:searchrequest>`,d.details=!0,(await y.search("/",d)).data.results.map(t=>m(t))}export{F as g};
//# sourceMappingURL=PhotoSearch-DTZLo_8Q.chunk.mjs.map

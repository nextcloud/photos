      ...
      return this.fileList.flatMap(function (file, index) {
        ...
        finalArray.push({
          ...
          injected: _objectSpread(_objectSpread({}, file), {}, {
            ...
            selected: _this2.selectedFiles[file.fileid]
          }),
          width: 256,
          height: 256,
          columnSpan: 1,
    ...
    ? _c(
        ...
        [
            ...
            [
              _c("VirtualGrid", {
                ...
                on: {
                  ...
                  "un-select-file": _vm.unSelectFile
                }
              })
            ],
            1
          ...
          _vm.selectedFilesCount > 0
            ? _c("SelectBar", {
                attrs: { "selected-files-count": _vm.selectedFilesCount },
                on: { "clear-selected-files": _vm.clearSelectedFiles }
              })
            : _vm._e()
        ],
        1
...
//# sourceMappingURL=photos-11.js.map?v=2d078e7ec76a358beca2
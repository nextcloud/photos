...
function _fetchAlbum() {
  _fetchAlbum = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(path, options) {
    var extraProps,
      client,
      response,
      _args = arguments;
...
function _fetchAlbums() {
  _fetchAlbums = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(path, options) {
    var extraProps,
      client,
      response,
      _args2 = arguments;
...
function _fetchAlbumContent() {
  _fetchAlbumContent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(path, options) {
    var client,
      response,
      fetchedFiles,
      _args3 = arguments;
...
//# sourceMappingURL=photos-src_services_Albums_js.js.map?v=33e2a278f95f8cf819d3
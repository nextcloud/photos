...
/* harmony import */ var vue_material_design_icons_ImagePlus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-material-design-icons/ImagePlus */ "./node_modules/vue-material-design-icons/ImagePlus.vue");
...
/* harmony import */ var _mixins_FetchCollectionsContentMixin_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../mixins/FetchCollectionsContentMixin.js */ "./src/mixins/FetchCollectionsContentMixin.js");
...
/* harmony import */ var _nextcloud_auth__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @nextcloud/auth */ "./node_modules/@nextcloud/auth/dist/index.esm.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    ImagePlus: vue_material_design_icons_ImagePlus__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  mixins: [_mixins_FetchCollectionsContentMixin_js__WEBPACK_IMPORTED_MODULE_4__["default"], _nextcloud_vue__WEBPACK_IMPORTED_MODULE_2__.isMobile],
  props: {
    placeName: {
      type: String,
      default: '/'
  ...
  computed: {
     ...
     */
    placeFileName: function placeFileName() {
      var _getCurrentUser;
      return "/photos/".concat((_getCurrentUser = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_7__.getCurrentUser)()) === null || _getCurrentUser === void 0 ? void 0 : _getCurrentUser.uid, "/places/").concat(this.placeName);
    },
    /**
     * @return {string[]} The list of files for the current placeName.
     */
    placeFileIds: function placeFileIds() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.fetchPlace();
            case 2:
              _context.next = 4;
              return _this.fetchPlaceFiles();
            case 4:
            case "end":
  ...
  methods: {
    fetchPlace: function fetchPlace() {
      var _this2 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.fetchCollection(_this2.placeFileName);
              case 1:
              case "end":
    ...
    fetchPlaceFiles: function fetchPlaceFiles() {
      var _this3 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _this3.fetchCollectionFiles(_this3.placeFileName);
              case 1:
              case "end":
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/views/PlaceContent.vue?vue&type=template&id=ed8a14a8&scoped=true&":
/*!****************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/views/PlaceContent.vue?vue&type=template&id=ed8a14a8&scoped=true& ***!
  \****************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("CollectionContent", {
    ...
    attrs: {
      slot: "empty-content",
      title: _vm.t("photos", "This place does not have any photos or videos yet!")
    },
    slot: "empty-content"
  }, [_c("ImagePlus", {
    attrs: {
...
/***/ "./src/mixins/FetchCollectionsContentMixin.js":
/*!****************************************************!*\
  !*** ./src/mixins/FetchCollectionsContentMixin.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)(['appendFiles', 'addCollections', 'setCollectionFiles'])), {}, {
    fetchCollection: function fetchCollection(collectionFileName) {
      var _this = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var collection, _error$response;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!_this.loadingCollection) {
                  _context.next = 2;
                  break;
                }
              ...
              case 2:
                ...
                _this.errorFetchingCollection = null;
                _context.next = 7;
                return (0,_services_collectionFetcher_js__WEBPACK_IMPORTED_MODULE_2__.fetchCollection)(collectionFileName, {
                  signal: _this.abortController.signal
                });
              case 7:
                collection = _context.sent;
                _this.addCollections({
              ...
              case 12:
                ...
                _this.errorFetchingCollection = 404;
                return _context.abrupt("return");
              case 17:
                _this.errorFetchingCollection = _context.t0;
                _services_logger_js__WEBPACK_IMPORTED_MODULE_3__["default"].error('[PublicCollectionContent] Error fetching collection', {
                  error: _context.t0
                });
                (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showError)(_this.t('photos', 'Failed to fetch collection.'));
              case 20:
                _context.prev = 20;
        ...
        }, _callee, null, [[2, 12, 20, 23]]);
      }))();
    },
    fetchCollectionFiles: function fetchCollectionFiles(collectionFileName) {
      var _this2 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!_this2.loadingCollectionFiles) {
                  _context2.next = 2;
                  break;
                }
              ...
              case 2:
                _context2.next = 4;
                return _this2.semaphore.acquire(function () {
                  return 0;
                }, 'fetchFiles');
              case 4:
                semaphoreSymbol = _context2.sent;
                _context2.next = 7;
                return _this2.fetchSemaphore.acquire();
              case 7:
                fetchSemaphoreSymbol = _context2.sent;
                _context2.prev = 8;
                _this2.errorFetchingCollectionFiles = null;
                _this2.loadingCollectionFiles = true;
                _this2.semaphoreSymbol = semaphoreSymbol;
                _context2.next = 14;
                return (0,_services_collectionFetcher_js__WEBPACK_IMPORTED_MODULE_2__.fetchCollectionFiles)(collectionFileName, {
                  signal: _this2.abortController.signal
                });
              case 14:
                fetchedFiles = _context2.sent;
                fileIds = fetchedFiles.map(function (file) {
                  return file.fileid.toString();
                });
                _this2.appendFiles(fetchedFiles);
                if (!(fetchedFiles.length > 0)) {
                  _context2.next = 20;
                  break;
                }
                _context2.next = 20;
                return _this2.$store.commit('setCollectionFiles', {
                  collectionFileName: collectionFileName,
                  fileIds: fileIds
                });
              case 20:
                return _context2.abrupt("return", fetchedFiles);
              case 23:
                _context2.prev = 23;
                _context2.t0 = _context2["catch"](8);
                if (!(((_error$response2 = _context2.t0.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) === 404)) {
                  _context2.next = 28;
                  break;
                }
                _this2.errorFetchingCollectionFiles = 404;
                return _context2.abrupt("return", []);
              case 28:
                _this2.errorFetchingCollectionFiles = _context2.t0;
                (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showError)(_this2.t('photos', 'Failed to fetch collections list.'));
                _services_logger_js__WEBPACK_IMPORTED_MODULE_3__["default"].error('[PublicCollectionContent] Error fetching collection files', {
                  error: _context2.t0
                });
              case 31:
                _context2.prev = 31;
                _this2.loadingCollectionFiles = false;
                _this2.semaphore.release(semaphoreSymbol);
                _this2.fetchSemaphore.release(fetchSemaphoreSymbol);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PlaceContent_vue_vue_type_template_id_ed8a14a8_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PlaceContent_vue_vue_type_template_id_ed8a14a8_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PlaceContent_vue_vue_type_template_id_ed8a14a8_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../node_modules/babel-loader/lib/index.js!../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../node_modules/vue-loader/lib/index.js??vue-loader-options!./PlaceContent.vue?vue&type=template&id=ed8a14a8&scoped=true& */ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/views/PlaceContent.vue?vue&type=template&id=ed8a14a8&scoped=true&");
...
//# sourceMappingURL=photos-src_views_PlaceContent_vue.js.map?v=6a196fe476503f400923
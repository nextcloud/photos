...
patcher.patch('request', _nextcloud_axios__WEBPACK_IMPORTED_MODULE_7__["default"]); // init webdav client on default dav endpoint

const remote = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_8__.generateRemoteUrl)(publicRootPath);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: { ...(0,vuex__WEBPACK_IMPORTED_MODULE_15__.mapGetters)(['files', 'publicAlbums', 'publicAlbumsFiles']),
  ...
  methods: { ...(0,vuex__WEBPACK_IMPORTED_MODULE_15__.mapActions)(['appendFiles', 'addPublicAlbums', 'addFilesToPublicAlbum', 'removeFilesFromPublicAlbum']),
    ...
    async fetchAlbumInfo() {
      ...
      try {
        ...
        const album = await (0,_services_Albums_js__WEBPACK_IMPORTED_MODULE_13__.fetchAlbum)(`/photospublic/${this.token}`, this.abortController.signal, '<nc:original-name />', this.publicClient);
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_6__.showError)(this.t('photos', 'Failed to fetch album.'));
      } finally {
    ...
    async fetchAlbumContent() {
      ...
      try {
        ...
        const fetchedFiles = await (0,_services_Albums_js__WEBPACK_IMPORTED_MODULE_13__.fetchAlbumContent)(`/photospublic/${this.token}`, this.abortController.signal, this.publicClient);
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_6__.showError)(this.t('photos', 'Failed to fetch albums list.'));

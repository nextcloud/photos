(self["webpackChunkphotos"] = self["webpackChunkphotos"] || []).push([["vendors-node_modules_nextcloud_vue_dist_Components_ActionButton_js-node_modules_nextcloud_vue-208129"],{
...
var VirtualGrid$1 = /*#__PURE__*/function (_Vue) {
  _inherits(VirtualGrid$1, _Vue);

  var _super = _createSuper(VirtualGrid$1);

  function VirtualGrid$1() {
    var _this2;

    _classCallCheck(this, VirtualGrid$1);
  ...
  _createClass(VirtualGrid$1, [{
    ...
    key: "onScrollElementChanged",
    value: function onScrollElementChanged(scrollElement, oldScrollElement) {
    ...
    value: function computeConfigData(containerData, items) {
      ...
      var elementWidth = containerData.elementSize ? containerData.elementSize.width : 0;
    ...
    value: function computeRenderData(configData, containerData, layoutData) {
      ...
      if (containerData.elementWindowOffset !== null) {
        ...
        var _iterator2 = _createForOfIteratorHelper(layoutData.cells),
            _step2;
...
var render = function render() {
  ...
  return _c("div", {
    ...
    style: (_style = {
      "display": "-ms-grid"
    }, _defineProperty2(_style, "display", "grid"), _defineProperty2(_style, "align-items", "center"), _defineProperty2(_style, "grid-template-columns", "repeat(" + _vm.configData.columnCount + ", 1fr)"), _defineProperty2(_style, "gap", _vm.configData.gridGap + "px"), _style)
...
//# sourceMappingURL=photos-vendors-node_modules_nextcloud_vue_dist_Components_ActionButton_js-node_modules_nextcloud_vue-208129.js.map?v=c31f6110b323c5fa49b5
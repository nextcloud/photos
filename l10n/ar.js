OC.L10N.register(
    ...
    "Add selection to album {albumName}" : "إضافة ما تمّ تحديده إلى الألبوم {albumName}",
    ...
    "Create public link share" : "إنشاء رابط مشاركة عام",
    ...
    "Add to {destination}" : "إضافة إلى {destination}",

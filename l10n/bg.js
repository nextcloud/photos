OC.L10N.register(
    ...
    "Add users who can edit your album" : "Добавяне на потребители, които могат да редактират вашия албум",
    "Share this album via link" : "Споделяне на този албум чрез връзка",
    "Search users, email or Federated Cloud ID" : "Търсете потребители, имейл или Federated Cloud ID/ИД за облачно пространство/",
    ...
    "This album does not exist" : "Този албум не съществува",
    ...
    "Download selection" : "Изтегляне на селекция",
    ...
    "Share the album" : "Споделяне на албума",
    "_Remove item from album_::_Remove selection from album_" : ["Премахване на селекция от албума","Премахване на селекция от албума"],
    "Create a new album" : "Създаване на нов албум",
    ...
    "Failed to update location of {albumName} to {newLocation}." : "Неуспешно актуализиране на местоположението на {albumName} в {newLocation}.",
    "Failed to delete {albumName}." : "Неуспешно изтриване на {albumName}.",

OC.L10N.register(
    ...
    "Go back" : "Jít zpět",
    "Select a custom date range" : "Vyberte uživatelsky určené datumové rozmezí",
    "Select a date range" : "Vybrat datumové rozmezí",
    "Date range" : "Datumové rozmezí",
    "Select filters" : "Vybrat filtry",
    "Dates" : "Data",
    ...
    "Failed to rename {currentCollectionFileName} to {newCollectionFileName}" : "Nepodařilo se přejmenovat {currentCollectionFileName} na {newCollectionFileName}",
    "Failed to update properties of {collectionFileName} with {properties}" : "Nepodařilo se zaktualizovat vlastnosti {collectionFileName} s {properties}",

OC.L10N.register(
    ...
    "Mark selection as favorite" : "Marker valg som favorit",
    ...
    "Copy the public link" : "Kopier det offentlige link",
    ...
    "Create public link share" : "Opret offentligt delingslink",
    ...
    "Favorite" : "Favorit",
    "Favorite image, open the full size \"{name}\" image" : "Favoritbillede, åben fuld størrelse \"{name}\" billede",
    ...
    "Select filters" : "Vælg filtre",
    "Dates" : "Datoer",
    "Jump to specific date in list" : "Hop til specifik dato i listen",
    "Jump to {date}" : "Hop til {date}",
    ...
    "Select the default upload location for your media" : "Vælg standard uploadplacering til dine medier",
    "Home" : "Hjemme",
    ...
    "Manage collaborators for this album" : "Administrer samarbejdspartnere for dette album",
    ...
    "This album does not have any photos or videos yet!" : "Dette album har endnu ingen fotos eller videoer!",
    ...
    "There is no album yet!" : "Der er endnu ikke noget album!",
    ...
    "There is no place yet!" : "Der er endnu ikke noget sted!",
    "Cover photo for shared album {albumName}" : "Forsidebillede til delt album {albumName}",
    "Back to tags overview" : "Tilbage til tags oversigt",
    "No photos with this tag yet" : "Endnu ingen fotos med dette tag",
    ...
    "Error fetching files" : "Fejl ved hentning af filer",
    "All your media" : "Alle dine medier",
    "Album {title}" : "Album {title}",
    "Shared Albums" : "Delte albums",
    ...
    "Failed to set favorite state for {fileId}" : "Kunne ikke indstille favorittilstand for {fileId}",

OC.L10N.register(
    ...
    "Search by file name" : "Nach Dateinamen suchen",
    ...
    "Jump to a month" : "Zu einem Monat springen",
    "Memories illustration" : "Memories-Illustration",
    "Map illustration" : "Karten-Illustration",
    "Faces illustration" : "Gesichts-Illustration",
    "Photos illustration" : "Fotos-Illustration",
    ...
    "{count} photos taken in one go" : "{count} Fotos auf einmal aufgenommen",
    "Select image {imageName}" : "Bild {imageName} auswählen",
    "Open the \"{name}\" folder" : "Ordner \"{name}\" öffnen",
    "Go back" : "Zurückgehen",
    "Failed to add {fileName} to the favorites" : "{fileName} konnte nicht zu den Favoriten hinzugefügt werden",
    "Failed to remove {fileName} from the favorites" : "{fileName} konnte nicht aus den Favoriten entfernt werden",
    "Failed to delete {fileName}" : "{fileName} konnte nicht gelöscht werden",
    "Actions for {name}" : "Aktionen für {name}",
    "View metadata" : "Metadaten anzeigen",
    ...
    "Are you sure you want to move \"{name}\" to the trash?" : "Soll \"{name}\" wirklich in den Papierkorb verschoben werden?",
    "Cancel" : "Abbrechen",
    "Move to trash" : "In den Papierkorb verschieben",
    "Photo metadata" : "Foto-Metadaten",
    "Filename" : "Dateiname",
    "Place" : "Ort",
    "Location" : "Ort",
    "This photo carries no camera metadata." : "Dieses Foto enthält keine Kamera-Metadaten.",
    "Both coordinates are required" : "Beide Koordinaten erforderlich",
    "Enter decimal degrees between -{limit} and {limit}" : "Dezimalgrade zwischen -{limit} und {limit} eingeben",
    "Failed to save the metadata of {fileName}" : "Metadaten von {fileName} konnten nicht gespeichert werden",
    "Date and time the photo was taken" : "Datum und Uhrzeit der Aufnahme des Fotos",
    "Latitude" : "Breitengrad",
    "Longitude" : "Längengrad",
    "Remove location" : "Ort entfernen",
    "{position} of {count}" : "{position} von {count}",
    "Failed to load the tags" : "Die Schlagworte konnten nicht geladen werden",
    "Failed to add the tag \"{tag}\"" : "Das Schlagwort \"{tag}\" konnte nicht hinzugefügt werden",
    "Failed to remove the tag \"{tag}\"" : "Das Schlagwort \"{tag}\" konnte nicht entfernt werden",
    "A tag named \"{tag}\" already exists" : "Ein Schlagwort mit dem Namen \"{tag}\" existiert bereits",
    "Failed to create the tag \"{tag}\"" : "Das Schlagwort \"{tag}\" konnte nicht erstellt werden",
    "No tag exists yet, the field below creates the first one." : "Es existiert noch kein Schlagwort, das Feld unten erstellt das erste.",
    "Tags of {name}" : "Schlagworte von {name}",
    ...
    "Play or pause the slideshow" : "Diashow abspielen oder pausieren",
    "Close the slideshow" : "Diashow schließen",
    "Show or hide photo metadata" : "Foto-Metadaten ein- oder ausblenden",
    ...
    "Open the Maps app" : "Die Karten-App öffnen",
    "Looking for geotagged photos…" : "Suche nach Fotos mit Geotags …",
    "No geotagged photos" : "Keine Fotos mit Geotags",
    "Photos taken with a device recording its location are shown on this map." : "Auf dieser Karte werden Fotos angezeigt, die mit einem Gerät aufgenommen wurden, das seinen Standort aufzeichnet.",
    "Play a slideshow of your {year} highlights" : "Eine Diashow Ihrer Highlights aus dem Jahr {year} abspielen",
    "Looking for memories…" : "Auf der Suche nach Memories …",
    "No memories yet" : "Bislang keine Memories",
    "Memories gather the photos of your trips and multi-day events." : "Memories sammelt die Fotos Ihrer Reisen und mehrtägigen Veranstaltungen.",
    "Year in review" : "Jahresrückblick",
    "Your {year} in photos" : "Ihr Jahr {year} in Bildern",
    "_%n highlight_::_%n highlights_" : ["%n Höhepunkt","%n Höhepunkte"],
    "_%n photo this year_::_%n photos this year_" : ["%n Foto dieses Jahr","%n Fotos dieses Jahr"],
    ...
    "Cover photo for shared album {albumName}" : "Titelbild für freigegebenes Album {albumName}",
    ...
    "Change tile density" : "Kacheldichte ändern",
    "Density" : "Dichte",
    "Small tiles" : "Kleine Kacheln",
    "Default" : "Standard",
    "Large tiles" : "Große Kacheln",
    ...
    "The folder {folder} does not exist anymore. You can remove it from your media folders in the Photos settings." : "Der Ordner {folder} existiert nicht mehr. Sie können ihn aus Ihrem Medienordner in den Fotoeinstellungen entfernen.",

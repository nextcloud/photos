OC.L10N.register(
    ...
    "The file is in the favorites" : "The file is in the favourites",
    "Could not upload the photo. If you are using photos for the first time, please ensure the \"Photos\" directory in your home folder does exist." : "Could not upload the photo. If you are using photos for the first time, please ensure the \"Photos\" directory in your home folder does exist.",
    "Open the \"{name}\" sub-directory" : "Open the \"{name}\" sub-directory",
    ...
    "Add photos to the album" : "Add photos to the album",
    "Failed to fetch albums list." : "Failed to fetch albums list.",
    "Shared albums" : "Shared albums",
    "Create a new album" : "Create a new album",
    "Add selection to an album" : "Add selection to an album",

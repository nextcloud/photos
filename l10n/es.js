OC.L10N.register(
    ...
    "Jump to a month" : "Saltar a un mes",
    "Memories illustration" : "Ilustración de memorias",
    "Map illustration" : "Ilustración de mapas",
    "Faces illustration" : "Ilustración de rostros",
    "Photos illustration" : "Ilustración fotográfica",
    ...
    "Are you sure you want to move \"{name}\" to the trash?" : "¿Estás seguro que quieres mover \"{name}\" a la papelera?",
    "Cancel" : "Cancelar",
    "Move to trash" : "Mover a la papelera",
    "Photo metadata" : "Metadatos de la foto",
    "Filename" : "Nombre de archivo",
    "Place" : "Lugar",
    "Location" : "Ubicación",
    "This photo carries no camera metadata." : "Esta foto no contiene metadatos de la cámara.",
    "Both coordinates are required" : "Se requieren ambas coordenadas",
    "Enter decimal degrees between -{limit} and {limit}" : "Escribe grados decimales entre -{limit} y {limit}",
    "Failed to save the metadata of {fileName}" : "Fallo al guardar los metadatos de {fileName}",
    "Date and time the photo was taken" : "Fecha y hora en la que se tomó la foto",
    "Latitude" : "Latitud",
    "Longitude" : "Longitud",
    "Remove location" : "Quitar ubicación",
    "Select a custom date range" : "Seleccione un rango de fechas personalizado",
    "Select a date range" : "Seleccione un rango de fechas",
    "Date range" : "Rango de fechas",
    "Select filters" : "Seleccione filtros",
    "Dates" : "Fechas",
    ...
    "The destination folder is owned by {owner}" : "La carpeta de destino es propiedad de {owner}",
    ...
    "Squared photos view" : "Vista de cuadrícula",
    "Delete source directory" : "Eliminar directorio de origen",
    "Pick folder" : "Escoja la carpeta",
    ...
    "Open the Maps app" : "Abrir la app de Mapas",
    "Looking for geotagged photos…" : "Buscando fotos geo-etiquetadas…",
    "No geotagged photos" : "No hay fotos geo-etiquetadas",
    "Photos taken with a device recording its location are shown on this map." : "En este mapa se muestran las fotos tomadas con un dispositivo que toma la ubicación.",
    "Play a slideshow of your {year} highlights" : "Reproduce una presentación con los mejores momentos de {year}.",
    "Looking for memories…" : "Buscando memorias…",
    "No memories yet" : "No hay memorias aún",
    "Memories gather the photos of your trips and multi-day events." : "Memorias recopila las fotos de tus viajes y eventos de varios días.",
    "Year in review" : "Resumen del año",
    "Your {year} in photos" : "Tu {year} en fotos",
    "_%n highlight_::_%n highlights_" : ["%n destacada","%n destacadas","%n destacadas"],
    "_%n photo this year_::_%n photos this year_" : ["%n foto este año","%n fotos este año","%n fotos este año"],
    ...
    "Cover photo for shared album {albumName}" : "Foto de la portada para el álbum compartido {albumName}",
    ...
    "Create new album from filters" : "Crear álbum nuevo desde los filtros",
    "One of the source folders does not exist" : "Una de las carpetas fuente no existe",
    "Change tile density" : "Cambiar la densidad de la cuadrícula",
    "Density" : "Densidad",
    "Small tiles" : "Pequeñas cuadrículas",
    "Default" : "Predeterminado",
    "Large tiles" : "Grandes cuadrículas",
    ...
    "Leave shared album" : "Dejar álbum compartido",
    "Are you sure you want to delete {collectionName}? This action cannot be undone." : "¿Estás seguro que quieres borrar {collectionName}? Esta acción no se puede deshacer.",
    ...
    "Failed to delete {faceName}" : "Fallo al eliminar {faceName}",
    "Failed to delete {fileId}" : "Fallo al eliminar {fileId}",

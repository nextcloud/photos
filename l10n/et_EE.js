OC.L10N.register(
    ...
    "Places" : "Kohad",
    "Map" : "Kaart",
    "Photos settings" : "Fotode seadistused",
    ...
    "Shared by" : "Jagas",
    "Create a new album." : "Koosta uus album.",
    "Create new album" : "Koosta uus album",
    "New album" : "Uus album",
    ...
    "More photos from this day" : "Rohkem pilte sellest päevast",
    "Jump to a month" : "Hüppa konkreetse kuu juurde",
    "Memories illustration" : "Mälestuste illustratsioon",
    "Map illustration" : "Kaardi illustratsioon",
    "Faces illustration" : "Nägude illustratsioon",
    "Photos illustration" : "Fotode illustratsioon",
    ...
    "Open the full size \"{name}\" image" : "Ava „{name}“ pilt täissuuruses",
    "{count} photos taken in one go" : "Korraga on pildistatud {count} fotot",
    "Select image {imageName}" : "Vali pilt „{imageName}“",
    "Open the \"{name}\" folder" : "Ava kaust \"{name}\"",
    "Go back" : "Mine tagasi",
    "Failed to add {fileName} to the favorites" : "„{fileName}“ faili lisamine lemmikute sekka ei õnnestunud",
    "Failed to remove {fileName} from the favorites" : "„{fileName}“ faili eemaldamine lemmikute seast ei õnnestunud",
    "Failed to delete {fileName}" : "Ei õnnestunud kustutada: „{fileName}“",
    "Actions for {name}" : "Tegevused „{name}“ pildiga",
    "View metadata" : "Vaata metaandmeid",
    ...
    "Are you sure you want to move \"{name}\" to the trash?" : "Kas sa oled kindel, et soovid „{name}“ foto visata prügikasti?",
    "Cancel" : "Katkesta",
    "Move to trash" : "Viska prügikasti",
    "Photo metadata" : "Foto metateave",
    "Filename" : "Failinimi",
    "Place" : "Koht",
    "Location" : "Toimumiskoht",
    "This photo carries no camera metadata." : "Selles fotos ei leidu kaamerakohaseid metaandmeid.",
    "Both coordinates are required" : "Vajalikud on mõlemad koordinaadid",
    "Enter decimal degrees between -{limit} and {limit}" : "Sisesta kraadid kümnendarvuna vahemikust -{limit} kuni {limit}",
    "Failed to save the metadata of {fileName}" : "„{fileName}“ faili metaandmete salvestamine ei õnnestunud",
    "Date and time the photo was taken" : "Pildistamise kuupäev ja kellaaeg",
    "Latitude" : "Laiuskraad",
    "Longitude" : "Pikkuskraad",
    "Remove location" : "Eemalda asukoht",
    "{position} of {count}" : "{position} / {count}",
    "Failed to load the tags" : "Siltide laadimine ei õnnestunud",
    "Failed to add the tag \"{tag}\"" : "„{tag}“ sildi lisamine ei õnnestunud",
    "Failed to remove the tag \"{tag}\"" : "„{tag}“ sildi eemaldamine ei õnnestunud",
    "A tag named \"{tag}\" already exists" : "„{tag}“ silt on juba olemas",
    "Failed to create the tag \"{tag}\"" : "„{tag}“ sildi loomine ei õnnestunud",
    "No tag exists yet, the field below creates the first one." : "Ühtegi silti veel ei leidu, alljärgnevalt väljalt saad ühe luua.",
    "Tags of {name}" : "„{name}“ faili sildid",
    ...
    "Play or pause the slideshow" : "Käivita slaidiesitlus või peata see",
    "Close the slideshow" : "Sulge slaidiesitlus",
    "Show or hide photo metadata" : "Näita foto metateavet või peida see",
    "Delete source directory" : "Kustuta lähtekaust",
    "Pick folder" : "Vali kaust",
    "Select a source folder for your media" : "Vali oma meediumile lähtekaust",
    "Media folders" : "Meediumikaustad",
    ...
    "Home" : "Avaleht",
    "Select the default upload location for your media" : "Vali oma meediumile vaikimisi üleslaadimise kaust",
    ...
    "This person could not be found" : "Seda inimest ei leidu",
    "Rename person" : "Muuda inimese nime",
    "Merge with different person" : "Mesti teise inimesega",
    "Download selected photos" : "Laadi valitud fotod alla",
    "Remove person" : "Eemalda isik",
    "Name of this person" : "Inimese nimi",
    "Save." : "Salvesta.",
    ...
    "_Remove photo from person_::_Remove photos from person_" : ["Eemalda foto inimese küljest","Eemalda fotod inimese küljest"],
    ...
    "Open the Maps app" : "Ava Nextcloudi kaardirakenduses",
    "Looking for geotagged photos…" : "Tuvastan geomärgistega fotosid…",
    "No geotagged photos" : "Geomärgistega fotosid ei leidu",
    "Photos taken with a device recording its location are shown on this map." : "Sellel kaardil kuvatakse fotod, mille metateabes leiduvad pildistamise koha koordinaadid.",
    "Play a slideshow of your {year} highlights" : "Näita slaidiesitust oma {year}. aasta parematest paladest",
    "Looking for memories…" : "Otsin mälestusi…",
    "No memories yet" : "Mälestusi veel pole",
    "Memories gather the photos of your trips and multi-day events." : "Mälestusena kogutakse kokku sinu reiside ja mitmepäevaset ürituste fotod.",
    "Year in review" : "Aasta ülevaade",
    "Your {year} in photos" : "Sinu fotod {year}. aastal",
    "_%n highlight_::_%n highlights_" : ["%n esiletõstmine","%n esiletõstmist"],
    "_%n photo this year_::_%n photos this year_" : ["Sellest aastast on %n foto","Sellest aastast on %n fotot"],
    ...
    "Change tile density" : "Muuda tihedust",
    "Density" : "Tihedus",
    "Small tiles" : "Väikesed paanid",
    "Default" : "Vaikimisi",

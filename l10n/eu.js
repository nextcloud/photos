OC.L10N.register(
    ...
    "Add users who can edit your album" : "Gehitu zure albuma editatu ahalko duten erabiltzaileak",
    "Share this album via link" : "Partekatu album hau esteka bidez",
    "Search users, email or Federated Cloud ID" : "Bilatu erabiltzaile, email edo federatutako hodei IDak",
    ...
    "Share the album" : "Partekatu albuma",
    "_Remove item from album_::_Remove selection from album_" : ["Ezabatu fitxategia albumetik","Kendu hautatutakoak albumetik"],
    ...
    "Failed to update location of {albumName} to {newLocation}." : "Ezin izan da {albumName} mugitu {newLocation} kokapenera.",
    "Failed to delete {albumName}." : "Ezin izan da  {albumName} ezabatu.",

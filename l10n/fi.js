OC.L10N.register(
    ...
    "Search by file name" : "Hae tiedoston nimellä",
    "Clear search" : "Tyhjennä haku",
    "All media" : "Kaikki media",
    "Videos" : "Videot",
    "Albums" : "Albumit",
    "Collaborative albums" : "Yhteiset albumit",
    "People" : "Ihmiset",
    "Folders" : "Kansiot",
    "Favorites" : "Suosikit",
    "On this day" : "Tänä päivänä",
    ...
    "Back" : "Takaisin",
    "Add collaborators" : "Lisää osanottajia",
    "Save" : "Tallenna",
    ...
    "No picture for this day" : "Ei kuvaa tälle päivälle",
    "Picture taken on this day will show up here." : "Tänä päivänä otettu kuva näkyy täällä.",
    "More photos from this day" : "Lisää kuvia tältä päivältä",
    "Jump to a month" : "Siirry kuukauteen",
    "Memories illustration" : "Muistokuvitus",
    "Map illustration" : "Karttakuvitus",
    "Faces illustration" : "Kasvokuvitus",
    "Photos illustration" : "Kuvakuvitus",
    "_%n photos_::_%n photos_" : ["%n kuva","%n kuvaa"],
    "_%n unassigned photo_::_%n unassigned photos_" : ["%n määrittämätön kuva","%n määrittämätöntä kuvaa"],
    "Favorite" : "Suosikki",
    "Open the full size \"{name}\" image" : "Avaa kuva \"{name}\" todellisessa koossa",
    "{count} photos taken in one go" : "{count} kuvaa otettu kerralla",
    ...
    "View metadata" : "Näytä metatiedot",
    ...
    "Are you sure you want to move \"{name}\" to the trash?" : "Haluatko siirtää kuvan \"{name}\" roskakoriin?",
    "Cancel" : "Peruuta",
    "Move to trash" : "Siirrä roskakoriin",
    "Photo metadata" : "Kuvan metatiedot",
    "Filename" : "Tiedostonimi",
    "Place" : "Paikka",
    "Location" : "Sijainti",
    "Both coordinates are required" : "Molemmat koordinaatit ovat pakollisia",
    "Latitude" : "Leveysaste",
    "Longitude" : "Pituusaste",
    "Remove location" : "Poista sijainti",
    "{position} of {count}" : "{position}/{count}",
    "Failed to load the tags" : "Tunnisteiden lataaminen epäonnistui",
    "Failed to add the tag \"{tag}\"" : "Tunnisteen \"{tag}\" lisääminen epäonnistui",
    "Failed to remove the tag \"{tag}\"" : "Tunnisteen \"{tag}\" poistaminen epäonnistui",
    "A tag named \"{tag}\" already exists" : "Tunniste nimellä \"{tag}\" on jo olemassa",
    "Failed to create the tag \"{tag}\"" : "Tunnisteen \"{tag}\" luominen epäonnistui",
    ...
    "Select filters" : "Valitse suodattimet",
    "Dates" : "Päivät",
    "Jump to specific date in list" : "Siirry määrättyyn päivään listassa",
    "Jump to {date}" : "Siirry päivään {date}",
    "Add to {destination}" : "Lisää kohteeseen {destination}",
    "The destination folder is owned by {owner}" : "Kohdekansion omistaa {owner}",
    "There are no photos or videos yet!" : "Ei kuvia tai videoita vielä!",
    ...
    "Play or pause the slideshow" : "Käynnistä tai jatka diaesitystä",
    "Close the slideshow" : "Sulje diaesitys",
    "Show or hide photo metadata" : "Näytä tai piilota kuvan metatiedot",
    "Delete source directory" : "Poista lähdekansio",
    "Pick folder" : "Valitse kansio",
    "Select a source folder for your media" : "Valitse median lähdekansio",
    "Media folders" : "Mediakansiot",
    "Choose the folders from where photos and videos are shown." : "Valitse kansiot, joista kuvat ja videot näytetään.",
    "All folders" : "Kaikki kansiot",
    "Add folder" : "Lisää kansio",
    "Home" : "Koti",
    "Select the default upload location for your media" : "Valitse oletussijainti lähetettävälle medialle",
    ...
    "There is no album yet!" : "Ei vielä albumia!",
    ...
    "Move to different person" : "Siirrä eri henkilöön",
    "_Move photo to a different person_::_Move photos to a different person_" : ["Siirrä kuva toiselle henkilölle","Siirrä kuvat toiselle henkilölle"],
    ...
    "Play a slideshow of your {year} highlights" : "Toista vuoden {year} kohokohdat",
    "Looking for memories…" : "Etsitään muistoja…",
    "No memories yet" : "Ei muistoja vielä",
    "Memories gather the photos of your trips and multi-day events." : "Muistot keräävät yhteen matkojen ja monipäiväisten tapahtumien kuvat.",
    "Year in review" : "Vuoden yhteenveto",
    "Your {year} in photos" : "Vuotesi {year} kuvina",
    "_%n highlight_::_%n highlights_" : ["%n kohokohta","%n kohokohtaa"],
    "_%n photo this year_::_%n photos this year_" : ["%n kuva tänä vuonna","%n kuvaa tänä vuonna"],
    "Taken on {date} at {time}" : "Otettu {date} kello {time}",
    "This place does not have any photos or videos yet!" : "Tässä sijainnissa ei ole vielä kuvia tai videoita!",
    ...
    "Error fetching files" : "Virhe tiedostoja noutaessa",
    "Failed to fetch collection." : "Kokoelman haku epäonnistui.",
    "Failed to fetch collections list." : "Kokoelmalistan haku epäonnistui.",
    "Failed to fetch faces list." : "Kasvolistauksen noutaminen epäonnistui.",
    "All your media" : "Kaikki media",
    "Album {title}" : "Albumi {title}",
    "Shared Albums" : "Jaetut albumit",
    "Shared album {title}" : "Jaettu albumi {title}",
    "Public album {title}" : "Julkinen albumi {title}",
    ...
    "Failed to add {fileBaseName} to collection {collectionFileName}" : "Kohteen {fileBaseName} lisääminen kokoelmaan {collectionFileName} epäonnistui",
    "Failed to delete {fileBaseName}" : "Kohteen {fileBaseName} poistaminen epäonnistui",
    "Failed to create {collectionFileName}" : "Kokoelman {collectionFileName} luominen epäonnistui",
    "Delete collection" : "Poista kokoelma",
    "Leave shared album" : "Poistu jaetusta albumista",
    "Are you sure you want to delete {collectionName}? This action cannot be undone." : "Haluatko varmasti poistaa kokoelman {collectionName}? Tätä toimintoa ei voi perua.",
    ...
    "Could not load photos folder" : "Kuvakansiota ei voitu ladata",
    "Camera" : "Kamera",
    "Aperture" : "Aukko",

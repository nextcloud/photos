OC.L10N.register(
    ...
    "Add users who can edit your album" : "Ajouter des utilisateurs qui peuvent modifier votre album",
    "Share this album via link" : "Partager cet album via un lien",
    "Search users, email or Federated Cloud ID" : "Recherche d'utilisateurs, d'e-mail ou d'identifiant Federated Cloud",
    ...
    "This album does not exist" : "Cet album n'existe pas",
    ...
    "Download selection" : "Télécharger la sélection",
    ...
    "Share the album" : "Partager l'album",
    "_Remove item from album_::_Remove selection from album_" : ["Retirer l'élément de l'album","Retirer l'élément de l'album","Retirer la sélection de l'album"],
    "Create a new album" : "Créer un nouvel album",
    ...
    "Add" : "Ajouter",
    "Upload media" : "Téléverser le média",
    ...
    "Failed to fetch albums list." : "Échec de la récupération de la liste des albums.",
    ...
    "Failed to update location of {albumName} to {newLocation}." : "Échec du déplacement de {albumName} vers {newLocation}.",
    "Failed to delete {albumName}." : "Échec de la suppression de {albumName}.",

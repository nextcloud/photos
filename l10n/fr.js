OC.L10N.register(
    ...
    "Select a custom date range" : "Sélectionnez une plage de dates personnalisée",
    ...
    "Details" : "Détails",
    "Failed to add {fileBaseName} to collection {collectionFileName}" : "Échec de l'ajout de {fileBaseName} à la collection {collectionFileName}",
    "Failed to delete {fileBaseName}" : "Échec de la suppression de {fileBaseName}.",
    "Failed to create {collectionFileName}" : "Impossible de créer {collectionFileName}",
    "Failed to rename {currentCollectionFileName} to {newCollectionFileName}" : "Échec du renommage de {currentCollectionFileName} en {newCollectionFileName}.",
    "Failed to update properties of {collectionFileName} with {properties}" : "Échec de la modification de {collectionFileName} avec {properties}",
    "Failed to delete {collectionFileName}" : "Échec de la suppression de {collectionFileName}.",
    "Failed to move {fileBaseName} to person {faceName}" : "Impossible de déplacer {fileBaseName} vers {faceName} ",
    "Failed to remove {fileBaseName}" : "Échec de la suppression de {fileBaseName}",
    ...
    "Failed to set favorite state for {fileName}" : "Impossible de définir l’état des favoris pour {fileName}.",

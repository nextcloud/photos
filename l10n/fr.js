OC.L10N.register(
    ...
    "Search by file name" : "Rechercher par nom",
    ...
    "Favorite" : "Favoris",
    "Favorite image, open the full size \"{name}\" image" : "Image favorite, ouvrir l'image \"{name}\" en taille réelle",
    "Open the full size \"{name}\" image" : "Ouvrir l’image « {name} » dans sa taille originale",
    "{count} photos taken in one go" : "{count} photos prises d'un coup",
    ...
    "Failed to remove {fileName} from the favorites" : "Échec de la suppression de {fileName} des favoris",
    ...
    "Enter decimal degrees between -{limit} and {limit}" : "Entrez une valeur décimale en degrés entre -{limit} et {limit}",
    ...
    "Failed to remove the tag \"{tag}\"" : "Échec de la suppression de l'étiquette « {tag} »",
    ...
    "Squared photos view" : "Vue des photos en carrés",
    "Slideshow" : "Diaporama",
    ...
    "Show or hide photo metadata" : "Afficher ou cacher les métadonnées des photos",
    ...
    "Media folders" : "Dossiers de médias",
    ...
    "_%n highlight_::_%n highlights_" : ["%n temps fort","%n temps forts","%n temps fort(s)"],
    "_%n photo this year_::_%n photos this year_" : ["%n photo cette année","%n photos cette année","%n photo(s) cette année"],
    ...
    "Error fetching files" : "Erreur dans la récupération des fichiers",
    ...
    "The folder {folder} does not exist anymore. You can remove it from your media folders in the Photos settings." : "Le dossier {folder} n'existe plus. Vous pouvez le supprimer de vos dossiers de médias dans les paramètres de Photos.",
    ...
    "Enable squared photos view" : "Activer la vue des photos en carrés",

OC.L10N.register(
    ...
    "Create the album." : "Búa til albúmið.",
    "Back to the new album form." : "Aftur á innfyllingarformið fyrir ný albúm.",
    "_Share with %n user_::_Share with %n users_" : ["Deila með %n notanda","Deila með %n notendum"],
    ...
    "The file is in the favorites" : "Skráin er í eftirlætunum",
    "Open the \"{name}\" sub-directory" : "Opna \"{name}\" undirmöppuna",
    "Default Photos upload and Albums location" : "Sjálfgefin staðsetning fyrir innsendingar ljósmynda og albúma",
    "Select the default location for your media" : "Veldu sjálfgefna staðsetningu fyrir myndefnið þitt",
    "Invalid location selected" : "Ógild staðsetning valin",
    "Photos directory" : "Ljósmyndamappa",
    "Add photos to the album" : "Bæta myndum í albúmið",
    "Failed to fetch albums list." : "Mistókst að ná í lista með albúmum.",
    "Shared albums" : "Sameiginleg albúm",
    "Create a new album" : "Búa til nýtt albúm",
    "Add selection to an album" : "Bæta vali í albúm",

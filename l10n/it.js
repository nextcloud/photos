OC.L10N.register(
    ...
    "Search by file name" : "Cerca per nome file",
    ...
    "Go back" : "Indietro",
    "Failed to delete {fileName}" : "Impossibile eliminare {fileName}",
    ...
    "Add" : "Aggiungi",
    "Select a custom date range" : "Seleziona un intervallo di date personalizzate",
    "Select a date range" : "Seleziona un intervallo di date",
    "Date range" : "Intervallo di date",
    "Select filters" : "Seleziona filtri",
    "Dates" : "Date",
    ...
    "Cover photo for album {albumName}" : "Foto di copertina per l'album {albumName}",
    ...
    "Create new album from filters" : "Crea un nuovo album dai filtri",
    ...
    "Failed to add {fileBaseName} to collection {collectionFileName}" : "Impossibile aggiungere {fileBaseName}alla raccolta {collectionFileName}",
    "Failed to delete {fileBaseName}" : "Impossibile eliminare {fileBaseName}",
    ...
    "Failed to move {fileBaseName} to person {faceName}" : "Impossibile spostare {fileBaseName} alla persona{faceName}",
    "Failed to remove {fileBaseName}" : "Impossibile rimuovere {fileBaseName}",
    "Failed to rename {oldName} to {faceName}" : "Impossibile rinominare {oldName} in {faceName}",
    "Failed to delete {faceName}" : "Impossibile eliminare {faceName}",
    "Failed to delete {fileId}" : "Impossibile eliminare {fileId}",
    "Failed to set favorite state for {fileId}" : "Impossibile impostare lo stato preferito per {fileId}",
    "Failed to set favorite state for {fileName}" : "Impossibile impostare lo stato preferito per {fileName}",
    ...
    "View" : "Visualizza",
    "Choose the folder where photos and albums are uploaded to." : "Scegli la cartella dove foto e album saranno caricati",
    "Loading folders …" : "Caricamento delle cartelle …",
    "Details" : "Dettagli",
    "Confirm" : "Conferma"
},

OC.L10N.register(
    ...
    "Create public link share" : "Креирај споделување со јавен линк",
    ...
    "No picture for this day" : "Нема слика за овој ден",
    "Picture taken on this day will show up here." : "Сликите направени на денешен ден ќе се појават тука.",
    "More photos from this day" : "Повеќе фотографии од овој ден",
    "_%n photos_::_%n photos_" : ["1 фотографија","%n фотографии"],
    "_%n unassigned photo_::_%n unassigned photos_" : ["%n неозначена фотографија","%n неозначени фотографии"],
    "Favorite" : "Омилени",
    "Favorite image, open the full size \"{name}\" image" : "Омилени слики, прикажи оргинална големина \"{name}\" ",
    "Open the full size \"{name}\" image" : "Отвори ја сликата \"{name}\" во целосна големина",
    "Select image {imageName}" : "Избери слика {imageName}",
    "Open the \"{name}\" folder" : "Отвори ја папката на \"{name}\"",
    "Go back" : "Назад",
    "Failed to delete {fileName}" : "Не успеа да се избрише {fileName}",
    "View metadata" : "Види метаподатоци",
    ...
    "Select a date range" : "Избери опсег",
    "Date range" : "Опсег",
    "Select filters" : "Избери филтри",
    "Dates" : "Датуми",
    "Jump to specific date in list" : "Оди го одреден датум на листата",
    "Jump to {date}" : "Оди до {date}",
    ...
    "Media folders" : "Медија папки",
    "Choose the folders from where photos and videos are shown." : "Изберете ги папките од каде што се прикажуваат фотографиите и видеата.",
    "All folders" : "Сите папки",
    "Add a Photos source for the timelines" : "Додај извор за фотографии за времепловот",
    "Add folder" : "Додади папка",
    "Home" : "Дома",
    "Select the default upload location for your media" : "Изберете стандардна локација за вашите прикачените медиа датотеки",
    ...
    "Add photos to {albumName}" : "Додади фотографии во {albumName}",
    ...
    "Move to different person" : "Премести кај другa личност",
    ...
    "Taken on {date} at {time}" : "Направена на {date} во {time}",
    ...
    "Create new album from filters" : "Креирај нов албум од филтрите",
    "One of the source folders does not exist" : "Една од папките на постои",
    ...
    "Error fetching files" : "Грешка при преземање на датотеки",
    ...
    "Failed to delete {faceName}" : "Не успеа да се избрише {faceName}",
    "Failed to delete {fileId}" : "Не успеа да се избрише {fileId}",
    "Failed to set favorite state for {fileId}" : "Не успеа да се постави состојбата на омилено за {fileId}",
    "Failed to set favorite state for {fileName}" : "Не успеа да се постави состојбата на омилено за {fileName}",
    "Could not load photos folder" : "Не можеше да се вчита папката со фотографии",
    "Camera" : "Камера",
    "Focal length" : "Фокусна должина",
    "Exposure" : "Експозитура",
    "Group" : "Група",

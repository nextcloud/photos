OC.L10N.register(
    ...
    "New album" : "Нов албум",
    "_Share with %n user_::_Share with %n others_" : ["Сподели со еден корисник","Сподели со %n други"],
    "Add users who can edit your album" : "Додади корисник кој ќе може да го ажурира твојот албум",
    "Share this album via link" : "Сподели го овој албум преку линк",
    "Search users, email or federated cloud ID" : "Барај корисници, е-пошта или федерален ИД",
    ...
    "Edit album's details" : "Уреди ги деталите на албумот",
    ...
    "Share the album" : "Сподели го албумот",
    "_Remove item from album_::_Remove selection from album_" : ["Отстрани од албум","Отстрани ги селектираните од албумот"],
    "Create a new album" : "Креирај нов албум",
    ...
    "Failed to update location of {albumName} to {newLocation}." : "Неуспешно ажурирање на локацијата на албумот {albumName} во {newLocation}.",
    "Failed to delete {albumName}." : "Неуспешно бришење на {albumName}.",

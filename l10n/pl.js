OC.L10N.register(
    ...
    "Cover photo for the \"{albumName}\" album." : "Zdjęcie na okładkę albumu \"{albumName}\".",
    ...
    "Add users who can edit your album" : "Dodaj użytkowników, którzy mogą edytować Twój album",
    "Share this album via link" : "Udostępnij ten album przez link",
    "Search users, email or Federated Cloud ID" : "Wyszukaj użytkowników, e-mail lub ID Chmury Federacyjnej",
    ...
    "Share the album" : "Udostępnij album",
    "_Remove item from album_::_Remove selection from album_" : ["Usuń element z albumu","Usuń wybrane z albumu","Usuń wybrane z albumu","Usuń wybrane z albumu"],
    "Create a new album" : "Utwórz nowy album",
    ...
    "Add" : "Dodaj",
    "Upload media" : "Wyślij multimedia",
    ...
    "Failed to update location of {albumName} to {newLocation}." : "Nie udało się zaktualizować lokalizacji {albumName} na {newLocation}.",
    "Failed to delete {albumName}." : "Nie udało się usunąć {albumName}.",

OC.L10N.register(
    ...
    "Squared photos view" : "Widok zdjęć w siatce",
    ...
    "Loading folders…" : "Pobieram katalogi…",
    ...
    "Cover photo for shared album {albumName}" : "Zdjęcie okładkowe dla udostępnionego albumu {albumName}",
    ...
    "Create new album from filters" : "Utwórz nowy album z filtrów",
    ...
    "Error fetching files" : "Błąd podczas pobierania plików",
    ...
    "Failed to add {fileBaseName} to collection {collectionFileName}" : "Nie udało się dodać {fileBaseName} do kolekcji {collectionFileName}",
    "Failed to delete {fileBaseName}" : "Nie udało się usunąć {fileBaseName}",
    "Failed to create {collectionFileName}" : "Nie udało się utworzyć {collectionFileName}",
    "Failed to rename {currentCollectionFileName} to {newCollectionFileName}" : "Nie udało się zmienić nazwy {currentCollectionFileName} na {newCollectionFileName}",
    "Failed to update properties of {collectionFileName} with {properties}" : "Nie udało się zaktualizować właściwości {collectionFileName} o {properties}",
    "Delete collection" : "Usuń kolekcję",
    "Leave shared album" : "Opuść album udostępniony",
    "Are you sure you want to delete {collectionName}? This action cannot be undone." : "Czy na pewno chcesz usunąć {collectionName}? Tej operacji nie można cofnąć.",
    "Failed to delete {collectionFileName}" : "Nie udało się usunąć {collectionFileName}",
    "Failed to move {fileBaseName} to person {faceName}" : "Nie udało się przenieść {fileBaseName} do osoby {faceName}",
    "Failed to remove {fileBaseName}" : "Nie udało się usunąć {fileBaseName}",
    ...
    "Failed to set favorite state for {fileId}" : "Nie udało się ustawić stanu ulubionego dla {fileId}",
    "Failed to set favorite state for {fileName}" : "Nie udało się ustawić stanu ulubionego dla {fileName}",
    "Could not load photos folder" : "Nie można wczytać katalogu ze zdjęciami",
    "Camera" : "Kamera",
    "Focal length" : "Długość ogniskowa",
    "Exposure" : "Ekspozycja",
    "Group" : "Grupa",

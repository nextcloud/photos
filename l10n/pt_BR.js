OC.L10N.register(
    ...
    "Favorite image, open the full size \"{name}\" image" : "Imagem favorita, abra a imagem \"{name}\" em tamanho real",
    "Open the full size \"{name}\" image" : "Abrir a imagem \"{name}\" no tamanho normal",
    "Open the \"{name}\" folder" : "Abra a pasta \"{nome}\"",
    "Go back" : "Voltar",
    ...
    "Could not upload the photo. If you are using photos for the first time, please ensure the \"Photos\" directory in your home folder does exist." : "Não foi possível enviar a foto. Se você estiver usando fotos pela primeira vez, certifique-se de que o diretório \"Fotos\" em sua pasta pessoal exista.",

OC.L10N.register(
    ...
    "Search by file name" : "Hľadať podľa názvu súboru",
    ...
    "Jump to a month" : "Prejsť na mesiac",
    "Memories illustration" : "Ilustrácia spomienok",
    "Map illustration" : "Ilustrácia mapy",
    "Faces illustration" : "Ilustrácia tvárí",
    "Photos illustration" : "Ilustrácia fotografií",
    ...
    "{count} photos taken in one go" : "{count} fotografií zhotovených naraz",
    "Select image {imageName}" : "Vybrať obrázok {imageName}",
    "Open the \"{name}\" folder" : "Otvoriť adresár \"{name}\"",
    "Go back" : "Ísť späť",
    "Failed to add {fileName} to the favorites" : "Nepodarilo sa pridať {fileName} do obľúbených",
    "Failed to remove {fileName} from the favorites" : "Nepodarilo sa odstrániť {fileName} z obľúbených",
    "Failed to delete {fileName}" : "Nepodarilo sa vymazať {fileName}",
    "Actions for {name}" : "Akcie pre {name}",
    "View metadata" : "Zobraziť metadáta",
    ...
    "Are you sure you want to move \"{name}\" to the trash?" : "Naozaj chcete presunúť „{name}“ do koša?",
    "Cancel" : "Cancel",
    "Move to trash" : "Presunúť do koša",
    "Photo metadata" : "Metaúdaje fotografie",
    "Filename" : "Názov súboru",
    "Place" : "Miesto",
    "Location" : "Miesto",
    "This photo carries no camera metadata." : "Táto fotografia neobsahuje žiadne metaúdaje z fotoaparátu.",
    "Both coordinates are required" : "Vyžadujú sa obe súradnice",
    "Enter decimal degrees between -{limit} and {limit}" : "Zadajte desatinné hodnoty medzi -{limit} a {limit}",
    "Failed to save the metadata of {fileName}" : "Nepodarilo sa uložiť metaúdaje súboru {fileName}",
    "Date and time the photo was taken" : "Dátum a čas odfotenia",
    "Latitude" : "Zemepisná šírka",
    "Longitude" : "Zemepisná dĺžka",
    "Remove location" : "Odstrániť polohu",
    "{position} of {count}" : "{position} z {count}",
    "Failed to load the tags" : "Nepodarilo sa načítať štítky",
    "Failed to add the tag \"{tag}\"" : "Nepodarilo sa pridať štítok „{tag}“",
    "Failed to remove the tag \"{tag}\"" : "Nepodarilo sa odstrániť štítok „{tag}“",
    "A tag named \"{tag}\" already exists" : "Štítok s názvom „{tag}“ už existuje",
    "Failed to create the tag \"{tag}\"" : "Nepodarilo sa vytvoriť štítok „{tag}“",
    "No tag exists yet, the field below creates the first one." : "Zatiaľ neexistuje žiadny štítok, nižšie uvedené pole vytvorí prvý.",
    "Tags of {name}" : "Štítky pre {name}",
    ...
    "Squared photos view" : "Zobrazenie štvorcových fotografií",
    "Slideshow" : "Prehliadka",
    "Previous photo" : "Predchádzajúca fotografia",
    "Next photo" : "Nasledujúca fotografia",
    "Play or pause the slideshow" : "Prehrať alebo pozastaviť prezentáciu",
    "Close the slideshow" : "Zavrieť prezentáciu",
    "Show or hide photo metadata" : "Zobraziť alebo skryť metaúdaje fotografie",
    "Delete source directory" : "Vymazať zdrojový adresár",
    "Pick folder" : "Vyberte adresár",
    ...
    "Open the Maps app" : "Otvoriť aplikáciu Mapy",
    "Looking for geotagged photos…" : "Hľadajú sa geotagované fotografie…",
    "No geotagged photos" : "Žiadne geotagované fotografie",
    "Photos taken with a device recording its location are shown on this map." : "Fotografie nasnímané zariadením, ktoré zaznamenáva svoju polohu, sa zobrazujú na tejto mape.",
    "Play a slideshow of your {year} highlights" : "Prehrať prezentáciu najlepších momentov z roku {year}",
    "Looking for memories…" : "Hľadajú sa spomienky...",
    "No memories yet" : "Zatiaľ žiadne spomienky",
    "Memories gather the photos of your trips and multi-day events." : "Spomienky zhromažďujú fotografie z vašich ciest a viacdňových podujatí.",
    "Year in review" : "Prehľad o roku",
    "Your {year} in photos" : "Váš {year} na fotkách",
    "_%n highlight_::_%n highlights_" : ["%n najlepší moment","%n najlepšie momenty","%n najlepších momentov","%n najlepších momentov"],
    "_%n photo this year_::_%n photos this year_" : ["%n fotografia v tomto roku","%n fotografie v tomto roku","%n fotografií v tomto roku","%n fotografií v tomto roku"],
    ...
    "Create new album from filters" : "Vytvoriť nový album z filtrov",
    "One of the source folders does not exist" : "Jeden zo zdrojových priečinkov neexistuje",
    "Change tile density" : "Zmeniť hustotu dlaždíc",
    "Density" : "Hustota",
    "Small tiles" : "Malé dlaždice",
    "Default" : "Predvolené",
    "Large tiles" : "Veľké dlaždice",
    ...
    "Error fetching files" : "Chyba pri získavaní súborov",
    ...
    "The folder {folder} does not exist anymore. You can remove it from your media folders in the Photos settings." : "Priečinok {folder} už neexistuje. Môžete ho odstrániť z priečinkov médií v nastaveniach aplikácie Fotky.",
    ...
    "Failed to update properties of {collectionFileName} with {properties}" : "Nepodarilo sa aktualizovať vlastnosti {collectionFileName} s {properties}",
    "Delete collection" : "Vymazať kolekciu",

OC.L10N.register(
    ...
    "Picture taken on this day will show up here." : "Tu sa zobrazí fotografia urobená v tento deň.",
    ...
    "Select the default upload location for your media" : "Vyberte východzie umiestnenie pre vaše médiá.",
    "View" : "Prezerať",
    "Media folders" : "Priečinky médií",
    "Choose the folders from where photos and videos are shown." : "Vyberte adresáre, z ktorých sa zobrazujú fotografie a videá.",
    "Upload folder" : "Nahrať adresár",
    "Choose the folder where photos and albums are uploaded to." : "Vyberať adresár, do ktorého sa nahrávajú fotografie a albumy.",
    ...
    "Move to different person" : "Prepnúť sa na inú osobu",
    ...
    "Cover photo for place {placeName}" : "Fotka obalu pre miesto {placeName}",
    ...
    "Unassigned faces" : "Nepridané tváre",
    ...
    "Shared album {title}" : "Sprístupnený album {title}",
    "Public album {title}" : "Verejný album {title}",
    "Tagged photos" : "Označené fotografie",
    "Tagged photo {title}" : "Oštítkovaná fotografia {title}",
    ...
    "Could not load photos folder" : "Nepodarilo sa načítať adresár s fotkami",

OC.L10N.register(
    ...
    "Create public link share" : "Ustvari povezavo za javno deljenje",
    "Share via public link" : "V souporabi z javno povezavo",
    "This collection does not exist" : "Zbirka ne obstaja.",
    "An error occurred" : "Prišlo je do napake.",
    "No picture for this day" : "Za ta dan ni slik",
    "Picture taken on this day will show up here." : "Slike zajete na ta dan se bodo prikazale tukaj",
    "More photos from this day" : "Več fotografij za ta dan",
    "_%n photos_::_%n photos_" : ["%n fotografija","%n fotografiji","%n fotografije","%n fotografij"],
    "_%n unassigned photo_::_%n unassigned photos_" : ["%n neoznačena fotografija","%n neoznačeni fotografiji","%n neoznačenih fotografij","%n neoznačenih fotografij"],
    ...
    "The destination folder is owned by {owner}" : "Ciljna mapa je v lasti {owner}",
    ...
    "Delete source directory" : "Izbriši izborno mapo",
    "Pick folder" : "Izberi mapo",
    "Select a source folder for your media" : "Izberite izvorno mapo za vaš medij",
    "Media folders" : "Medijske mape",
    "Choose the folders from where photos and videos are shown." : "Izberite mape, od koder bodo prikazane fotografije in videi",
    "All folders" : "Vse mape",
    "Add a Photos source for the timelines" : "Dodajte vir fotografij za časovnico",
    "Add folder" : "Dodaj mapo",
    "Home" : "Začetna stran",
    "Select the default upload location for your media" : "Izberite privzeto mesto nalaganja za vaš medij",
    ...
    "Add photos to {albumName}" : "Dodaj fotografije v {albumName}",
    ...
    "Move to different person" : "Premakni k drugi osebi",
    "_Move photo to a different person_::_Move photos to a different person_" : ["Premakni sliko k drugi osebi","Premakni sliki k drugi osebi","Premakni slike k drugi osebi","Premakni fotografije k drugi osebi"],
    "_Remove photo from person_::_Remove photos from person_" : ["Odstrani sliko od osebe","Odstrani sliki od osebe","Odstrani slike od osebe","Odstrani fotografijo od osebe"],
    "This might take some time depending on the size of your photo library." : "To lahko vzame nekaj časa, odvisno od velikosti albuma fotografij",
    "Recognized people will show up here" : "Prepoznane osebe se bodo prikazale tukaj",
    ...
    "Taken on {date} at {time}" : "Zajeto {date} ob {time}",
    "This place does not have any photos or videos yet!" : "Ta prostor še nima nobene fotografije ali videa!",
    "Add photos to this place" : "Dodaj fotografije v ta prostor",
    "Cover photo for place {placeName}" : "Naslovna fotografija za prostor {placeName}",
    "Cover photo for shared album {albumName}" : "Naslovna fotografija za deljen album {albumName}",
    ...
    "Error fetching files" : "Napaka pri pridobivanju datotek",
    "Failed to fetch collection." : "Spodletelo pridobivanje zbirk.",

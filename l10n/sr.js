OC.L10N.register(
    ...
    "Select filters" : "Изаберите филтере",
    "Dates" : "Датуми",
    ...
    "Loading folders…" : "Учитавам фасцикле…",
    ...
    "Failed to delete {fileBaseName}" : "Није успело брисање {fileBaseName}",
    "Failed to create {collectionFileName}" : "Није могла да се креира {collectionFileName}",
    "Failed to rename {currentCollectionFileName} to {newCollectionFileName}" : "Није успела промена имена {currentCollectionFileName} у {newCollectionFileName}",
    "Failed to update properties of {collectionFileName} with {properties}" : "Није успело ажурирање особина {collectionFileName} са {properties}",
    "Failed to delete {collectionFileName}" : "Није успело брисање {collectionFileName}",
    "Failed to move {fileBaseName} to person {faceName}" : "Није успело премештање {fileBaseName} особи {faceName}",
    "Failed to remove {fileBaseName}" : "Није успело уклањање {fileBaseName}",

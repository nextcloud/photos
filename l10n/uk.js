OC.L10N.register(
    ...
    "Remove selection from favorites" : "Видалити вибір із вибраного",
    ...
    "Add selection to album {ablumName}" : "Додати виділення до альбому {ablumName}",
    ...
    "Select the default location for your media" : "Виберіть розташування за умовчанням для медіа",
    ...
    "_Remove photo from person_::_Remove photos from person_" : ["Видалити фото з особи","Видалити фотографії з особи","Видалити фотографії з особи","Видалити фотографії з особи"],
    ...
    "This folder does not exist" : "Ця папка не існує",
    ...
    "Failed to delete {faceName}." : "Не вдалося видалити {faceName}.",
    "Failed to delete {fileId}." : "Не вдалося видалити {fileId}.",

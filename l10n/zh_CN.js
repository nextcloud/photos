OC.L10N.register(
    ...
    "Failed to fetch albums list." : "无法获取相册列表。",
    "Shared albums" : "共享的相册",
    ...
    "Failed to set favorite state for {fileId}." : "未能为 {field} 设定最爱状态",
    "Failed to set favorite state for {fileName}." : "未能为 {fileName} 设定最爱状态",
    "Your photos" : "你的照片",
    "Your videos" : "您的视频",
    "Your folders" : "您的文件夹",
    "Locations" : "地点",

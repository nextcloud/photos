OC.L10N.register(
    ...
    "The file is in the favorites" : "此文件在最爱中",
    "Could not upload the photo. If you are using photos for the first time, please ensure the \"Photos\" directory in your home folder does exist." : "无法上传图片。如果你是第一次使用照片功能，请确保“照片”所在路径位于你的主文件夹中。",
    ...
    "Add photos to the album" : "添加照片至此相册",
    "Failed to fetch albums list." : "获取相册列表失败。",
    "Shared albums" : "共享的相册",
    "Create a new album" : "创建新相册",
    "Add selection to an album" : "将所选项添加至相册",

OC.L10N.register(
    ...
    "Popular tags" : "常用标签",
    "All tags" : "所有标签",
    "Create new album from filters" : "从筛选器创建新相册",
    ...
    "Failed to fetch collection." : "无法获取收藏。",
    "Failed to fetch collections list." : "无法获取收藏列表。",
    "Failed to fetch faces list." : "无法获取人脸列表。",
    "Error fetching files" : "获取文件时出错",
    "All your media" : "所有媒体",
    ...
    "Details" : "详情",
    "Failed to add {fileBaseName} to collection {collectionFileName}" : "无法将 {fileBaseName} 添加到收藏 {collectionFileName}",
    "Failed to delete {fileBaseName}" : "无法删除 {fileBaseName}",
    "Failed to create {collectionFileName}" : "无法创建 {collectionFileName}",
    "Failed to rename {currentCollectionFileName} to {newCollectionFileName}" : "无法将 {currentCollectionFileName} 重命名为 {newCollectionFileName}",
    "Failed to update properties of {collectionFileName} with {properties}" : "无法使用 {properties} 更新 {collectionFileName} 的属性",
    "Delete collection" : "删除收藏",
    "Leave shared album" : "离开共享相册",
    "Are you sure you want to delete {collectionName}? This action cannot be undone." : "是否确定要删除 {collectionName}？此操作无法撤销。",
    "Failed to delete {collectionFileName}" : "无法删除 {collectionFileName}",
    "Cancel" : "取消",
    "Confirm" : "确认",
    "Failed to move {fileBaseName} to person {faceName}" : "无法将 {fileBaseName} 移至人物 {faceName}",
    "Failed to remove {fileBaseName}" : "无法移除 {fileBaseName}",

...
<template>
	<Content app-name="photos">
		<AppNavigation>
			<template #list>
				<AppNavigationItem :to="{ name: 'timeline' }" class="app-navigation__allmedia " :title="t('photos', 'All Media')" icon="icon-yourphotos allmedia" exact/>
				<AppNavigationItem to="/images" class="app-navigation__photos " :title="t('photos', 'Your photos')" icon="icon-yourphotos allphotos" />

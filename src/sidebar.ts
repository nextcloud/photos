...
let photosTabInstance: ComponentPublicInstance<PhotosTabType> | null = null

// TODO(phase-4): OCA.Files.Sidebar was deprecated in Nextcloud 33; migrate
// to the replacement registration API once the photos app moves to that line.
...
const photosTab = new OCA.Files.Sidebar.Tab({
	...
	async mount(el, fileInfo) {
		...
		photosTabInstance = photosTabApp.mount(el) as ComponentPublicInstance<PhotosTabType>
